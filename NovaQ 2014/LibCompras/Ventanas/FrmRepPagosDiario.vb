...
Public Class FrmRepPagosDiario
    ...
    Private Sub FrmRepPagosDiario_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        Try
            ...
            'Me.Cursor = Cursors.WaitCursor
            dt_tmp = reporteBL.Get_PagosDiario(Ref_fecIni, Ref_fecFin)
