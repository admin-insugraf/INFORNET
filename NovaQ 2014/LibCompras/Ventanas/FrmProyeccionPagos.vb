...
Public Class FrmProyeccionPagos
    ...
    Private Sub FrmProyeccionPagos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MostrarReporte(ByVal FechaIni As String, ByVal FechaFin As String, _
        ...
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporteProyPagos(FechaIni, FechaFin, TODOS, cliente_inicial, cliente_final, vendedor_inicial, vendedor_final)
            Dim Nombre_rep As String = ""
            Nombre_rep = "REP_PROYECPAGOS.rpt"

            dtDatosCompany = reporteBL.Obtener_Datos_Empresa()

            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte(Nombre_rep, "", "", "", "XVEN1;" & txtclienteInicialDesc.Text, "XVEN2;" & txtclienteFinalDesc.Text, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString, _
