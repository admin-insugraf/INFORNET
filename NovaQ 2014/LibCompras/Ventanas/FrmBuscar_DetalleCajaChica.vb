...
Public Class FrmBuscar_DetalleCajaChica
    ...
    Private Sub FrmBuscar_DetalleCajaChica_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub txtFiltro_TextChanged(sender As Object, e As EventArgs) Handles txtFiltro.TextChanged
        ...
        Else
            ...
            If dtv.Count() = 0 Then
                ...
                STRorden = dgvdato.Columns(5).Name
                dtv.RowFilter = STRorden & " like '%" & txtFiltro.Text & "%'"
                If dtv.Count() = 0 Then
                    STRorden = String.Empty
                    STRorden = dgvdato.Columns(6).Name
                    dtv.RowFilter = STRorden & " like '%" & txtFiltro.Text & "%'"
                    If dtv.Count() = 0 Then
                        STRorden = String.Empty
                        STRorden = dgvdato.Columns(8).Name
                        dtv.RowFilter = STRorden & " like '%" & txtFiltro.Text & "%'"
                        If dtv.Count() = 0 Then
                            STRorden = String.Empty
                            STRorden = dgvdato.Columns(5).Name & "+" & dgvdato.Columns(6).Name & "+" & dgvdato.Columns(8).Name
                            lblCantidad.Text = "Se encontraron " & dtv.Count & " registros"
                            Exit Sub
                        End If
                    End If
