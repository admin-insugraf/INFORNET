...
Public Class FrmMorosidadPagos
    ...
    Private Sub MostrarReporte(ByVal FechaIni As String, ByVal FechaFin As String, _
        ...
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporteMorosidadPagos(FechaIni, FechaFin, TODOS, cliente_inicial, cliente_final, vendedor_inicial, vendedor_final)

            Nombre_rep = "REPMOROSIDADPAGOSPROVEEDOR.rpt"
            ...
            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte(Nombre_rep, "", "", "", "XVEN1;" & filtro_uno, "XVEN2;" & filtro_dos, "RUC;" & dtDatosCompany.Rows(0).Item("VAT_REGISTRATION").ToString, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString, _
    ...
    Private Sub FrmMorosidadPagos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        dtpfechaInicio.MaxDate = CDate(ClsVarComun.FechaSistema)
        dtpfechaFin.MaxDate = CDate(ClsVarComun.FechaSistema)
        dtpfechaInicio.Value = ModFunciones.Primer_Dia_Mes(ClsVarComun.FechaSistema)
        dtpfechaFin.Value = CDate(ClsVarComun.FechaSistema)
    End Sub
End Class