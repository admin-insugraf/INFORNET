...
Public Class ClsOperaciones
    ...
    Public Class SOLICITANTE
        ...
        Public Function ActualizarSolicitante(ent_cab As ClsEntidades.SOLICITANTE) As Boolean
        ...
        Public Function GuardarSolicitante(ent_cab As ClsEntidades.SOLICITANTE) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
    ...
    Public Class AREA
        ...
        Public Function ActualizarArea(ent_cab As ClsEntidades.AREA) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
        ...
        Public Function GuardarArea(ent_cab As ClsEntidades.AREA) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
    ...
    Public Class REQUIREMENT
        ...
        Public Function get_DatosGenerales_Guia_Devolucion(ByVal _FECHA_INI As String, ByVal _FECHA_FIN As String, ByVal _OPCION As Integer, ByVal _Tipo As String, _
        ...
        Public Function Actualizar_Guia_Devolucion(ent_cab As ClsEntidades.GUIA_DEVOLUCION, lista As List(Of ClsEntidades.GUIA_DEVOLUCION_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                With ent_cab
                    SqlHelper.ExecuteNonQuery(tr, "ALM_SP_U_GUIA_DEVOLUCION", .ID, .TYPE, .REQUIRED_USER, .REQUIRED_DATE, .COMMENT,
                                              .PART_ID, .PART_DESCRIPTION, .LOTE, .VCTO_LOTE, .CANTIDAD, .AREA_ID, .STATUS, _
                ...
                For Each d As ClsEntidades.GUIA_DEVOLUCION_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "ALM_SP_I_GUIA_DEVOLUCION_LINE", .ID, .TYPE, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .N_ANALISIS, .STATUS, _
        ...
        Public Function Guardar_Guia_Devolucion(ent_cab As ClsEntidades.GUIA_DEVOLUCION, lista As List(Of ClsEntidades.GUIA_DEVOLUCION_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                'cabecera doc
                With ent_cab
                    SqlHelper.ExecuteNonQuery(tr, "ALM_SP_I_GUIA_DEVOLUCION", .ID, .TYPE, .REQUIRED_USER, .REQUIRED_DATE, .COMMENT, _
                                               .PART_ID, .PART_DESCRIPTION, .LOTE, .VCTO_LOTE, .CANTIDAD, .AREA_ID, _
        ...
        Public Function ActualizarRequisiciones(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                SqlHelper.ExecuteNonQuery(tr, CommandType.Text, SQL)
                For Each d As ClsEntidades.REQUIREMENT_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_REQUIEREMENT_LINE_II", .ID, .TYPE, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .STATUS, _
        ...
        Public Function ActualizarRequisiciones_RM(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                'cabecera doc
                With ent_cab
                    SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_U_REQUEREMENT_RM", .ID, .TYPE, .REQUIRED_USER, .REQUIRED_DATE, .COMMENT, .AREA_ID, .STATUS, _
                ...
                For Each d As ClsEntidades.REQUIREMENT_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_REQUIEREMENT_LINE_RM", .ID, .TYPE, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .STATUS, _
        ...
        Public Function ActualizarRequisiciones_Imprenta(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE), lista_lotes As List(Of ClsEntidades.REQUIREMENT_LINE_IMPRENTA), lista_me As List(Of ClsEntidades.REQUIREMENT_LINE_IMPRENTA_ME)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                SqlHelper.ExecuteNonQuery(tr, CommandType.Text, SQL)
                For Each d As ClsEntidades.REQUIREMENT_LINE_IMPRENTA In lista_lotes
                    With d
                ...
                SqlHelper.ExecuteNonQuery(tr, CommandType.Text, SQL)
                For Each d As ClsEntidades.REQUIREMENT_LINE_IMPRENTA_ME In lista_me
                    With d
        ...
        Public Function GuardarRequerimientos(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
        ...
        Public Function GuardarRequerimientos_RM(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                'cabecera doc
                With ent_cab
                    SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_REQUEREMENT_RM", .ID, .TYPE, .REQUIRED_USER, .REQUIRED_DATE, .COMMENT, .AREA_ID, .STATUS, _
        ...
        Public Function GuardarRequerimientos_Imprenta(ent_cab As ClsEntidades.REQUIREMENT, lista As List(Of ClsEntidades.REQUIREMENT_LINE), lista_lotes As List(Of ClsEntidades.REQUIREMENT_LINE_IMPRENTA), lista_me As List(Of ClsEntidades.REQUIREMENT_LINE_IMPRENTA_ME)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
    ...
    Public Class PURCHASE_ORDER
        ...
        Public Function Cierre_Manual_Oden_Compra(ByVal CODIGO As String, ByVal TIPO_DOC As String, ByVal SERIE_DOC As String, _
        ...
        Public Sub ActualizandoEstado(ByVal LISTA_ENT_DET As List(Of ClsEntidades.PURCHASE_ORDER_LINE))
            Try
        ...
        Public Sub ActualizandoEstadoOrdenServicio(ByVal LISTA_ENT_DET As List(Of ClsEntidades.PURCHASE_ORDER_LINE))
            Try
                ''Actualizando el Estado --
                'REQUISICIONES
                'Dim sql As String = ""
        ...
        Public Sub ActualizandoEstadoOrdenServicio_Imprenta(ByVal LISTA_ENT_DET As List(Of ClsEntidades.PURCHASE_ORDER_LINE))
            Try
                ''Actualizando el Estado --
                'REQUISICIONES
                'Dim sql As String = ""
        ...
        Public Function GuardarOrdenCompra(ByVal Ent_cab As ClsEntidades.PURCHASE_ORDER, lista As List(Of ClsEntidades.PURCHASE_ORDER_LINE), _
            ...
            Try
                ...
                '+++++++
                With Ent_cab
                    SqlHelper.ExecuteNonQuery(tr, "PUR_SP_I_ORDEN_COMPRA_CAB_IV", .ID, .TYPE, .DOCUMENT_DATE, .VENDOR_ID, .NUMBER_ESTIMATING, .CURRENCY_TYPE, .TERMS_NAME, _
                                              ...
                                              .ADDR_FACT, .REFER_DOCUMENT_TYPE, .REFER_DOCUMENT_NUMBER, .PROJECT_ID, .FLAG_PROMISE_DATE, .AMOUNT_FLETE, .FLAG_FLETE_IGV, _
                ...
                For Each d As ClsEntidades.PURCHASE_ORDER_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "PUR_SP_I_ORDEN_COMPRA_DET_I", .ID, .TYPE, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .UNIT_REFERENCE, .FACTOR_REFERENCE, .QTY, _
                                                  .PRICE, .DISCOUNT_PER, .DISCOUNT, .AMOUNT_TAX, .PERCENT_TAX, .PRICE_NET, .AMOUNT_TOTAL, .AMOUNT_TOTAL_NET, .QTY_ENTER, .QTY_OUT, _
                                                  .STATUS_ID, .COMMENT1, .TEXT_COMMENT, .IS_VAT, .PRICE_UNIT, .CCOST_ID, .PROJECT_ID, .AREA_ID, .COTI_ID, .REQUI_ID, .FLAG_FREE_IGV, _
        ...
        Public Function GuardarOrdenServicio(ByVal Ent_cab As ClsEntidades.PURCHASE_ORDER, lista As List(Of ClsEntidades.PURCHASE_ORDER_LINE), _
                                          ByVal TipoAnexDocuem As String, ByVal Edicion As Boolean) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
        ...
        Public Function GuardarOrdenServicio_Imprenta(ByVal Ent_cab As ClsEntidades.PURCHASE_ORDER, lista As List(Of ClsEntidades.PURCHASE_ORDER_LINE), _
                                          ByVal TipoAnexDocuem As String, ByVal Edicion As Boolean, lista_lotes As List(Of ClsEntidades.PURCHASE_ORDER_LINE_LOTES)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                For Each d As ClsEntidades.PURCHASE_ORDER_LINE_LOTES In lista_lotes
                    With d
    ...
    Public Class PURCHASE_FACT_SUPPLIER
        ...
        Public Function VerificarDocumentos(ByVal _NombreStore As String, ByVal _DOCUMENT_ID As String, _
        ...
        Public Function GuardarCompra(ByVal Ent_cab As ClsEntidades.PURCHASE_FACT_SUPPLIER, lista As List(Of ClsEntidades.PURCHASE_FACT_SUPPLIER_LINE), _
                                           ByVal TipoAnexDocuem As String, ByVal _opcion_nuevo As Boolean, ByVal DT_DETALLE_DOC_REF As DataTable, ByVal Ent_cab_Importacion As ClsEntidades.REFERENCES_DOCUMENT_IMPORTACION_COMPRAS) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                With Ent_cab
                    Dim a As Integer
                    a = SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_COMPRA_CAB", .ID, .TYPE, .DOCUMENT_DATE, .VENDOR_ID, .NUMBER_ESTIMATING, .CURRENCY_TYPE, .TERMS_NAME, _
                                              .SELL_RATE, .PROMISE_DATE, .COMMENT, .AUTORIZED_ID, .BUYER_PURCHASE_ID, .TIME_DLV, .ADDR_DLV, .STATUS_ID, .AMOUNT, .DISCOUNT, _
                                              .AMOUNT_TAX, .AMOUNT_SALES, .UPDATE_DATE, .UPDATE_HOUR, .USER_ID, .CURR_EXCHANGE_TYPE, .NAME_FACT, .VAT_REGISTRATION_FACT, _
                                              .ADDR_FACT, .REFER_DOCUMENT_TYPE, .REFER_DOCUMENT_NUMBER, _
                                              .SERIE, .EXPIRATION_DATE, .BUDGET_ID, .ORDER_BUY_ID, .NOTE_IN_ID, .WAREHOUSE_ID, .TYPE_DESTINE, .REFER_DOCUMENT_DATE, .CREATE_DATE, _
                                              .PERCENT_DETRAC, .COM_PER_ID, .COM_PER_TD, .COM_PER_SERIE, .COM_PER_NUMERO, .COM_PER_PERCENT, .COM_PER_DATE_EMISION, _
                                              .COM_PER_DATE_VCTO, .TD_AN, .SERIE_AN, .NUMERO_AN, .FECHA_AN, .MONTO_AN, .CENTRO_DE_COSTOS, .NUM_ORDER_PAGO, .AMOUNT_INAFECTO, _
                ...
                For Each d As ClsEntidades.PURCHASE_FACT_SUPPLIER_LINE In lista
                    With d
                        Dim a As Integer
                        a = SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_COMPRA_DET_I", .ID, .TYPE, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .UNIT_REFERENCE, .FACTOR_REFERENCE, .QTY, _
                                                  .PRICE, .DISCOUNT_PER, .DISCOUNT, .AMOUNT_TAX, .PERCENT_TAX, .PRICE_NET, .AMOUNT_TOTAL, .AMOUNT_TOTAL_NET, .QTY_ENTER, .QTY_OUT, _
        ...
        Public Function Guardar_Importacion(ByVal Ent_cab As ClsEntidades.PURCHASE_FACT_SUPPLIER_IMPORT, lista As List(Of ClsEntidades.PURCHASE_FACT_SUPPLIER_LINE_IMPORT), _
                                           ByVal _opcion_nuevo As Boolean, _
                                           ByVal Ent_cab_Importacion As ClsEntidades.PURCHASE_FACT_SUPPLIER_LINE_IMPORT_GASTOS_VARIOS) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                If _opcion_nuevo = True Then
                    With Ent_cab
                        a = SqlHelper.ExecuteScalar(tr, "COMPRA_SP_I_PURCHASE_FACT_SUPPLIER_IMPORT", .ID, .VENDOR_ID, .INVOICE, .FECHA_INVOICE, .NRO_DAM, .FECHA_DAM, _
                ...
                Else
                    ...
                    With Ent_cab
                        SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_U_PURCHASE_FACT_SUPPLIER_IMPORT", .ID, .VENDOR_ID, .INVOICE, .FECHA_INVOICE, .NRO_DAM, .FECHA_DAM, _
                                                      .CURRENCY_TYPE, .SELL_RATE, .COMMENT, .USER_ID, .STATUS_ID)
                    End With
                End If
                ...
                With Ent_cab_Importacion
                    SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_PURCHASE_FACT_SUPPLIER_LINE_IMPORT_GASTOS_VARIOS", Ent_cab.ID, .COMISION_AGENCIA_ADUANAS2, .GASTOS_OPERATIVOS, _
                                              .GASTOS_ADMINISTATIVOS, .HANDLING_DESTINO, .TRANSMISION_MANIFIESTO, .GASTOS_OPERACIONAL_DESTINO, .SEGURO3, .ALMACEN, _
                                              .VISTOS_BUENOS, .DEVOLUCION_CONTENEDOR, .DESCONSOLIDACION, .REPARACION_CONTENEDOR, .RECTIFICACION_MANI, _
                                              .FLETE_MARITIMO, .TRANSPORTE_TERRESTRE)
                End With

                For Each d As ClsEntidades.PURCHASE_FACT_SUPPLIER_LINE_IMPORT In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "COMPRA_SP_I_PURCHASE_FACT_SUPPLIER_LINE_IMPORT", Ent_cab.ID, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .DAM, _
                                                  .QTY, .PRICE, .PRICE_TOTAL, .AD_VALOREM2, .ISC, .IGV, .IPM, .DERECHOS_ESPECIFICOS, .DERECHOS_ANTIDUMPING, .SEGURO2, _
                                                  .SOBRETASA_TRIBUTO, .SOBRETASA_SANCION, .PERCEPCION2, .VALOR_REF_FLETE_DAM, .FLETE_DAM, .SEGURO_DAM, .AD_VALOREM_DAM, _
                                                  .IGV_DAM, .IPM_DAM, .PERCEPCION_DAM, .COMISION_AGENCIA_ADUANAS2, .GASTOS_OPERATIVOS, .GASTOS_ADMINISTRATIVOS, _
                                                  .HANDLING_DESTINO, .TRANSMISION_MANIFIESTO, .GASTOS_OPERACIONAL_DESTINO, .SEGURO3, .ALMACEN, .VISTOS_BUENOS, _
                                                  .DEVOLUCION_CONTENEDOR, .DESCONSOLIDACION, .REPARACION_CONTENEDOR, .RECTIFICACION_MANI, .FLETE_MARITIMO, _
                                                  .TRANSPORTE_TERRESTRE, .TC, .TOTAL_COSTO_AGENCIA_ADUANAS, .COSTO_INVOICE2_TOTAL, .COSTO_ADVALOREM_TOTAL, _
        ...
        Public Function Guardar_Licitacion(ByVal Ent_cab As ClsEntidades.LICITACION, DT_INGRESO As DataTable, NUM_ENTREGAS As Integer, OPCION_IGV As Integer) As Boolean
            Dim estados As Boolean = True
            Dim a As Integer = 0
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                'For Each d As ClsEntidades.LICITACION_LINE In lista
                '    With d
                ...
                '    End With
                'Next
                Dim CompraDetENT = New ClsEntidades.LICITACION_LINE
                For i As Integer = 0 To DT_INGRESO.Rows.Count() - 1
                    ...
                    With CompraDetENT
                        ...
                        For j As Integer = 1 To NUM_ENTREGAS
                            ...
                            SqlHelper.ExecuteNonQuery(tr, "VENTAS_SP_I_LICITACIONES_LINE", a, .ITEM, .PART_ID, _
                            .DESCRIPTION, .UNIT, .PRESENTACION, .CANTIDAD_TOTAL, .COD_CLIENTE, .CLIENTE, .RUC, _
                            .CANTIDAD_CLIENTE, .PRECIO, .PRECIO_CON_IGV, .PRECIO_SIN_IGV, .VALOR_VENTA, .IGV_ART, .IMPORTE, _
    ...
    Public Class USUARIO
        ...
        Public Function GuardandoPurchaseQuote(ent_cab As ClsEntidades.PURCHASE_QUOTE, lista As List(Of ClsEntidades.PURCHASE_QUOTE_LINE), _
            ...
            Try
                ...
                For Each Row As DataRow In data_Proveedores.Rows
                    ...
                    With ent_cab
                        ...
                        SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_I_PURCHASE_QUOTE", .ID, .DOCUMENT_DATE, Row("ID").ToString, .CURRENCY_ID, .COMMENT, .COMMENT_COT, IIf(.QUOTE_DATE = "", DBNull.Value, .QUOTE_DATE), .SCTIPCAM, _
                                                  .SCVALIDEZ, .SCTIEMENT, .SCFORPAG, .SCNCOTIZ, .CREATE_DATE, IIf(.UPDATE_DATE = "", DBNull.Value, .UPDATE_DATE), .USER_ID, .PROJECT_ID, .STATUS)
                    End With
                    'detalle del documento
                    For Each d As ClsEntidades.PURCHASE_QUOTE_LINE In lista
                        With d
                            SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_I_PURCHASE_QUOTE_LINE", ent_cab.ID, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .PRICE, .AMOUNT_TAX, .AMOUNT, _
        ...
        Public Function Guardando_ActCotizacion(ent_cab As ClsEntidades.PURCHASE_QUOTE, lista As List(Of ClsEntidades.PURCHASE_QUOTE_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                With ent_cab
                    ...
                    SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_U_ACT_PURCHASE_QUOTE", .ID, .DOCUMENT_DATE, .VENDOR_ID, .CURRENCY_ID, .COMMENT, .COMMENT_COT, IIf(.QUOTE_DATE = "", DBNull.Value, .QUOTE_DATE), .SCTIPCAM, _
                                              .SCVALIDEZ, .SCTIEMENT, .SCFORPAG, .SCNCOTIZ, .CREATE_DATE, IIf(.UPDATE_DATE = "", DBNull.Value, .UPDATE_DATE), .USER_ID, .PROJECT_ID, .STATUS)
                End With
                ...
                For Each d As ClsEntidades.PURCHASE_QUOTE_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_U_ACT_PURCHASE_QUOTE_LINE", .ID, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .PRICE, .AMOUNT_TAX, .AMOUNT, _
            ...
            Return estados
        End Function
        Public Function ActualizandoPurchaseQuote(ent_cab As ClsEntidades.PURCHASE_QUOTE, lista As List(Of ClsEntidades.PURCHASE_QUOTE_LINE)) As Boolean
            Dim estados As Boolean = True
            Dim tr As SqlTransaction
            tr = cn.BeginTransaction(IsolationLevel.Serializable)
            Try
                ...
                With ent_cab
                    ...
                    SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_I_PURCHASE_QUOTE", .ID, .DOCUMENT_DATE, .VENDOR_ID, .CURRENCY_ID, .COMMENT, .COMMENT_COT, IIf(.QUOTE_DATE = "", DBNull.Value, .QUOTE_DATE), .SCTIPCAM, _
                                              .SCVALIDEZ, .SCTIEMENT, .SCFORPAG, .SCNCOTIZ, .CREATE_DATE, IIf(.UPDATE_DATE = "", DBNull.Value, .UPDATE_DATE), .USER_ID, .PROJECT_ID, .STATUS)
                End With
                ...
                For Each d As ClsEntidades.PURCHASE_QUOTE_LINE In lista
                    With d
                        SqlHelper.ExecuteNonQuery(tr, "COMPRAS_SP_I_PURCHASE_QUOTE_LINE", .ID, .ITEM, .PART_ID, .PART_DESCRIPTION, .UNIT, .QTY, .PRICE, .AMOUNT_TAX, .AMOUNT, _
                                                  .GUARANTEE, .QUALITY, .MARK, .COMMENT, .CURRENCY_ID, .DISCOUNT, IIf(.DLV_DATE = "", DBNull.Value, .DLV_DATE), .IS_VAT, .PROJECT_ID, .CC_ID, .AREA_ID, .REQUI_ID, .REQUI_TYPE)
                    End With
                Next
                tr.Commit()
