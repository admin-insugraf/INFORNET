...
Public Class Frm_Co_Doc_Pendientes
    ...
    Private Sub Frm_Co_Doc_Pendientes_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Frm_Co_Doc_Pendientes_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
