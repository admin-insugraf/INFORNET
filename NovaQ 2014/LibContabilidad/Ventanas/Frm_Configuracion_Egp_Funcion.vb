...
Public Class Frm_Configuracion_Egp_Funcion
    ...
    Private Sub Frm_Configuracion_Egp_Funcion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DocumentosPrincipal()
        Try
            ...
            dtCabecera = AsientoBl.Conceptos_EGP_Funcion()
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            If AsientoBl.Modificar_Cuentas_EGP_Funcion(txtcodigoConcepto.Text, ListaDetalles) = True Then
    ...
    Private Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        Try
            ...
            AsientoBl = New ClsOperaciones.Asiento_Contable
            GenerarColummnaDataTable()
            dtdetalleConceptos = AsientoBl.Conceptos_EGP_Funcion_Cuentas(Codigo)
            If dtdetalleConceptos.Rows.Count() <> 0 Then
                dgvDetalle.DataSource = dtdetalleConceptos
