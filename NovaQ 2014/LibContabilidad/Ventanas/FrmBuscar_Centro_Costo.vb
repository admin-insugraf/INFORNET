...
Public Class FrmBuscar_Centro_Costo
    ...
    Private Sub FrmBuscar_Centro_Costo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MostrarBusqueda()
        Try
            ...
            If dtData.Rows.Count() <> 0 Then
                ...
                dgvdato.Columns(0).HeaderText = "Descripción"
                dgvdato.Columns(1).HeaderText = "Destino Debe"
                dgvdato.Columns(2).HeaderText = "Destino Haber"

                STRorden = dgvdato.Columns(0).Name & "+" & dgvdato.Columns(1).Name & "+" & dgvdato.Columns(2).Name
        ...
        Else
            ...
            If dtv.Count() = 0 Then
                ...
                If dtv.Count() = 0 Then
                    ...
                    If dtv.Count() = 0 Then
                        STRorden = String.Empty
                        STRorden = dgvdato.Columns(2).Name
                        dtv.RowFilter = STRorden & " like '%" & txtFiltro.Text & "%'"
                        If dtv.Count() = 0 Then
                            STRorden = String.Empty
                            STRorden = dgvdato.Columns(0).Name & "+" & dgvdato.Columns(1).Name & "+" & dgvdato.Columns(2).Name
