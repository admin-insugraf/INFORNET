...
Public Class Frm_Configuracion_Egp_Naturaleza
    ...
    Private Sub Frm_Configuracion_Egp_Naturaleza_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DocumentosPrincipal()
        Try
            ...
            dtCabecera = AsientoBl.Conceptos_EGP_Naturaleza()
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        Try
            ...
            If AsientoBl.Modificar_Cuentas_EGP_Naturaleza(txtcodigoConcepto.Text, ListaDetalles) = True Then
    ...
    Private Sub btnConsultar_Click(sender As Object, e As EventArgs) Handles btnConsultar.Click
        Try
            ...
            dtdetalleConceptos = AsientoBl.Conceptos_EGP_Naturaleza_Cuentas(Codigo)
            If dtdetalleConceptos.Rows.Count() <> 0 Then
                dgvDetalle.DataSource = dtdetalleConceptos
