...
Public Class FrmPersonal
    ...
    Private Sub Cargar_Datos()
        ...
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Personal_Caja_Chica()
        If dtdetalles.Rows.Count() <> 0 Then
            ...
            dgv_Lista.Columns(2).HeaderText = "D.N.I"
    ...
    Private Sub Obtener_Codigo()
        ...
        dtdetalles = New DataTable("Datos")
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Codigo_Personal_CajaChica()
        If dtdetalles.Rows.Count() > 0 Then
            _NUEVO_CODIGO = Format(CType(dtdetalles.Rows(0).Item("CODIGO").ToString, Decimal), "00")
        End If
        tipoPagoBL = Nothing
    End Sub
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        If txt_des.Text.Trim = "" Then
            Avisar("Ingrese la descripción")
            txt_des.Focus()
            Exit Sub
        End If

        If txt_dni.Text.Trim = "" Then
            Avisar("Ingrese el número de D.N.I")
            txt_dni.Focus()
            Exit Sub
        End If
        ...
        If bol_nuevo Then
            If termsBL.Insert_Personal_Caja_chica(termsBE) Then
                Call Avisar("Proceso generado correctamente!")
                btn_cancelar_Click(sender, e)
                dgv_Lista.Focus()
            End If
        Else
            If termsBL.Update_Personal_Caja_Chica(termsBE) Then
                Call Avisar("Proceso generado correctamente!")
                btn_cancelar_Click(sender, e)
                dgv_Lista.Focus()
            End If
    ...
    Private Sub btn_Editar_Click(sender As Object, e As EventArgs) Handles btn_Editar.Click
        ...
        txt_dni.Text = dgv_Lista.CurrentRow.Cells(2).Value.ToString
        CONTROLES(TabPage1, False)
        CONTROLES(TabPage2, True)
        Botonera_Estado_Cambiar(True)
        txt_des.Focus()
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            ...
            termsBL.Delete_Personal_CajaChica(termsBE)
            termsBE = Nothing
            termsBL = Nothing
            Call Cargar_Datos()
            Call Avisar("Proceso generado correctamente!")
