...
Public Class FrmConceptos
    ...
    Private Sub Cargar_Datos()
        ...
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Conceptos_Caja_Chica()
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        Dim termsBE As New ClsEntidades.TRANSACTION_TYPE_CAJA_CHICA
        ...
        If bol_nuevo Then
            termsBL.Insert_Concepto_Caja_chica(termsBE)
        Else
            termsBL.Update_Concepto_Caja_Chica(termsBE)
        End If
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            ...
            termsBL.Delete_Concepto_CajaChica(termsBE)
            termsBE = Nothing
            termsBL = Nothing
            Call Cargar_Datos()
            Call Avisar("Proceso generado correctamente!")
    ...
    Private Sub txt_cod_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod.KeyDown
        If e.KeyCode = Keys.Enter Then
            If Validar_Codigo(txt_cod.Text) = True Then
                txt_des.Focus()
            End If
        End If
    End Sub
    ...
    Private Function Validar_Codigo(ByVal _CODIGO As String) As Boolean
        ...
        dtdetalles = New DataTable("Datos")
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_ValidarCodigo_Concepto_CajaChica(_CODIGO)
        If dtdetalles.Rows.Count() > 0 Then
