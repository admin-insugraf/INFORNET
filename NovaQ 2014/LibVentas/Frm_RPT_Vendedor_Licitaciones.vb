...
Public Class Frm_RPT_Vendedor_Licitaciones
    Dim reporteBL As ClsBuscar
    Dim crystalBL As ClsReporte
    Dim dtImprimir As DataTable

    Private Sub Frm_RPT_Vendedor_Licitaciones_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ImprimirReporte()
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporteVendedor_Licitacion(txtVendedorInicial.Text.Trim, dtpfechaInicio.Value.ToString("dd/MM/yyyy"), dtpfechaFin.Value.ToString("dd/MM/yyyy"), IIf(checkVendedor.Checked, "T", ""))
            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("rpt_vendedor_x_Licitacion.rpt", dtImprimir, "", "", "FI;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "FF;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"))
            Else
