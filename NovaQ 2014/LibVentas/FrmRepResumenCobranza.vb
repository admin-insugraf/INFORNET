...
Public Class FrmRepResumenCobranza
    ...
    Private Sub FrmRepResumenCobranza_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MostrarReporte(ByVal FechaIni As String, ByVal FechaFin As String, _
        ...
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporteResumenCobranza(FechaIni, FechaFin, TODOS, cliente_inicial, cliente_final, vendedor_inicial, vendedor_final, documento_inicial, documento_final, opcion)
            Dim Nombre_rep As String = ""
            Dim filtro_uno As String = ""
            Dim filtro_dos As String = ""
            If rb_cliente.Checked = True Then
                Nombre_rep = "REPRESUMENCOBRANZACLIENTE.rpt"
                filtro_uno = txtclienteInicialDesc.Text
                filtro_dos = txtclienteFinalDesc.Text
            ElseIf rb_vendedor.Checked = True Then
                Nombre_rep = "REPRESUMENCOBRANZAVENDEDOR.rpt"
                filtro_uno = txtvendedorInicialDesc.Text
                filtro_dos = txtvendedorFinDesc.Text
            ElseIf rb_documento.Checked = True Then
                Nombre_rep = "REPRESUMENCOBRANZADOCUMENTO.rpt"
