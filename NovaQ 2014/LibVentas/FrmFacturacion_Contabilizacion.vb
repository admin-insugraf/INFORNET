...
Public Class FrmFacturacion_Contabilizacion
    ...
    Private Sub FrmFacturacion_Contabilizacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If cboopcionesBusqueda.SelectedIndex = 3 Then
                ...
                Else
                    ...
                    dtv = New DataView
                    dtDocumentoFactura = clsFacturaBl.get_Busqueda_Rapida_Contabilizacion(txtFiltro.Text.Trim, IIf(cboOpcionTipoDoc.SelectedIndex = 0, "", cboOpcionTipoDoc.Text))
                    dgvDocumentosFactura.DataSource = Nothing
                    If dtDocumentoFactura.Rows.Count() <> 0 Then
                        ...
                        dgvDocumentosFactura.Columns(3).Width = 50
                        dgvDocumentosFactura.Columns(4).Width = 90
                        ...
                        dgvDocumentosFactura.Columns(0).Visible = False
            ...
            Else
                ...
                dtDocumentoFactura = New DataTable
                dtv = New DataView
                dtDocumentoFactura = clsFacturaBl.get_DatosGeneralesFacturacion_Contabilizacion(dtpfechaInicial.Value.ToString("dd/MM/yyyy"), dtpfechafinal.Value, _
    ...
    Private Sub btnContabilizar_Click(sender As Object, e As EventArgs) Handles btnContabilizar.Click
        ...
        End If
        Me.Cursor = Cursors.WaitCursor
        If MessageBox.Show("¿Desea contabilizar los documentos de Ventas?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            For i As Integer = 0 To dgvDocumentosFactura.Rows.Count - 1
                ...
                Ref_DOCUMENT_ID = dgvDocumentosFactura.Rows(i).Cells("DOCUMENT_ID").Value.ToString
                Ref_NUMBER_SERIE = dgvDocumentosFactura.Rows(i).Cells("NUMBER_SERIE").Value.ToString
                Ref_NUMBER_DOCUMENT = dgvDocumentosFactura.Rows(i).Cells("NUMBER_DOCUMENT").Value.ToString
                ...
                If dtImprimir.Rows.Count > 0 Then
                    If dtImprimir.Rows(0).Item("AC_ID").ToString <> "" Then
                        ...
                        Else
                            ...
                            'If Contabilizar_Ventas_Contado(Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT) = True Then
                            '    'DocumentosFactura()
                            'Else
                            '    'DocumentosFactura()
                            '    MsgBox("El documento " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " no se contabilizo." & Chr(13) & " Realizar la revisión.", MsgBoxStyle.Exclamation, "Sistemas")
    ...
    Private Function Contabilizar_Individual(ByVal TipoDoc As String, ByVal SerieDoc As String, ByVal NumDoc As String, ByVal num_asiento As String) As Boolean
        Try
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            If clsFacturaBl.Contabilizar_Individual(TipoDoc, SerieDoc, NumDoc, num_asiento) Then
                'MsgBox("Proceso de Contabilización generado correctamente.", MsgBoxStyle.Information)
                Return True
            Else
                Return False
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        End If
        Me.Cursor = Cursors.WaitCursor
        If MessageBox.Show("¿Desea contabilizar el documento seleccionado?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
            Ref_DOCUMENT_ID = String.Empty
            Ref_NUMBER_SERIE = String.Empty
            Ref_NUMBER_DOCUMENT = String.Empty
                ...
                If dtImprimir.Rows(0).Item("AC_ID").ToString <> "" Then
                    ...
                    Else
                        ...
                        If MessageBox.Show("¿Desea numeracion Automatica para el Comprobante?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                            ...
                            _num_voucher = ac.get_Ult_num_voucher("02", fecha.Year, Format(fecha.Month, "00"))
                            ac = Nothing
                        Else
                            ...
                            dtcodigo = ClsasientoBl.ValidarCodigo_Cobranzas("02", codigo, fecha.Year, fecha.Month)
                            ...
                            End If
                        End If
                        If Contabilizar_Individual(Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT, _num_voucher) = True Then
                            'DocumentosFactura()
                        Else
                            'DocumentosFactura()
                            MsgBox("El documento " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " no se contabilizo." & Chr(13) & " Realizar la revisión.", MsgBoxStyle.Exclamation, "Sistemas")
