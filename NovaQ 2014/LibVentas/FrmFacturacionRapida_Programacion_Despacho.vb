...
Public Class FrmFacturacionRapida_Programacion_Despacho
    ...
    Private Sub FrmFacturacionRapida_Programacion_Despacho_Load(sender As Object, e As EventArgs) Handles MyBase.Load
