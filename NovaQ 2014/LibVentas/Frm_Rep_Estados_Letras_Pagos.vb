...
Imports LibReportes
Public Class Frm_Rep_Estados_Letras_Pagos
    Dim reporteBL As ClsBuscar
    Dim crystalBL As ClsReporte
    Dim dtImprimir As DataTable
    Private Sub Frm_Rep_Estados_Letras_Pagos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Ayuda_Vendedor()
        Try
            ...
            sql = "COB_SP_S_ESTADOS_LETRAS_PAGOS_II"
    ...
    Private Sub ImprimirReporte()
        ...
        Try
            ...
            dtImprimir = reporteBL.Get_Rep_Estados_de_Letras_Pagos(txtClienteInicial.Text.Trim, dtpfechaInicio.Value.ToString("dd/MM/yyyy"), _
                                                             dtpfechaFin.Value.ToString("dd/MM/yyyy"), _
                                                             txt_cod_cliente.Text.Trim, txt_num_letra.Text.Trim, IIf(rdb_emision.Checked, "1", "2"))
            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("REP_ESTADOS_LETRAS_PAGOS.rpt", dtImprimir, "", "", "XVEN1;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), _
                                          "XVEN2;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"), _
