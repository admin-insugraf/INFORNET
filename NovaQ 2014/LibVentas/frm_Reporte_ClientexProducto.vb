...
Public Class frm_Reporte_ClientexProducto
    ...
    Private Sub ImprimirReporte()
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporteVentasClienteProducto(IIf(checkVendedor.Checked = True, "", txtClienteInicial.Text), dtpfechaInicio.Value.ToString("dd/MM/yyyy"), dtpfechaFin.Value.ToString("dd/MM/yyyy"), IIf(chk_productos.Checked = True, "", txtProductoInicial.Text))
            If dtImprimir.Rows.Count() <> 0 Then
                If rdb_detallado.Checked = True Then
                    crystalBL.Muestra_Reporte("rpt_Ventas_Cliente_x_producto.rpt", dtImprimir, "", "", "@CLIENTE;" & txtClienteInicial.Text, "@FECHA_INI;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "@FECHA_FIN;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"), "@PRODUCTO;" & txtProductoInicial.Text, "FECHA_INI;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "FECHA_FIN;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"))
                ElseIf rdb_resumido.Checked = True Then
                    crystalBL.Muestra_Reporte("rpt_Ventas_Cliente_x_producto_resumido.rpt", dtImprimir, "", "", "@CLIENTE;" & txtClienteInicial.Text, "@FECHA_INI;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "@FECHA_FIN;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"), "@PRODUCTO;" & txtProductoInicial.Text, "FECHA_INI;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "FECHA_FIN;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"))
                End If
            Else
