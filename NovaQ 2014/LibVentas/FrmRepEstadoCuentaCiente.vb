...
Public Class FrmRepEstadoCuentaCiente
    Dim reporteBL As ClsBuscar
    Dim crystalBL As LibReportes.ClsReporte
    Dim dtImprimir As DataTable
    Dim dtDatosCompany As DataTable
    Private Sub FrmRepEstadoCuentaCiente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MostrarReporte(ByVal FechaIni As String, ByVal FechaFin As String, _
        ...
        Try
            ...
            dtImprimir = reporteBL.EjecutarReporte_Estado_Cuenta_Cliente(FechaIni, FechaFin, cliente_inicial, todos)
            Dim Nombre_rep As String = ""
            
            Nombre_rep = "REP_ESTADO_CUENTA_CLIENTE.rpt"

            dtDatosCompany = reporteBL.Obtener_Datos_Empresa()

            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte(Nombre_rep, dtImprimir, "", "", "@CUSTOMER_ID;" & cliente_inicial, "@FECHA_INI;" & FechaIni, "@FECHA_FIN;" & FechaFin, "@TODOS;" & todos, "RUC;" & dtDatosCompany.Rows(0).Item("VAT_REGISTRATION").ToString, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString)
            Else
