...
Public Class frmBuscar
    ...
    Private Sub MostrarBusquedaFiltros()
        Try
            ...
            dtv = New DataView
            dtData = New DataTable
            If _Filtros2 = String.Empty And _Filtros3 = String.Empty Then
                dtData = clsBusquedaBl.Get_MostrarDescripcionFiltros(CadenaConsulta, Filtros1)
            ElseIf _Filtros2 <> String.Empty And _Filtros3 = String.Empty Then
                dtData = clsBusquedaBl.Get_MostrarDescripcionFiltros(CadenaConsulta, Filtros1, Filtros2)
            Else
                dtData = clsBusquedaBl.Get_MostrarDescripcionFiltros_Adicional(CadenaConsulta, Filtros1, Filtros2, Filtros3)
            End If
            If dtData.Rows.Count() <> 0 Then
                dtv = dtData.DefaultView
                dgvdato.DataSource = dtv
