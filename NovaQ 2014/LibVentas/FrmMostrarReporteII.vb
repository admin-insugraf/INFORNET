...
Public Class FrmMostrarReporteII
        ...
        Try
            ...
            Select Case _opcion
                Case "Reporte6"
                    ...
                    NombreStore = "DOC_PENDIENTES_GV_X_CLIENTES"
    ...
    Private Sub MostrarDatos()
        Try
            ...
            If rbdocumento.Checked = True Then
                nombreStore = "ALM_SP_S_WAREHOUSE_DOC"
            ElseIf rbproducto.Checked = True Then
                nombreStore = "ALM_SP_S_WAREHOUSE_PROD"
            End If
    ...
    Private Function ValidacionesReporte(ByRef fecha_Inicial As String, ByRef fecha_Final As String, ByRef Filtro As String, _
        ...
        Try
            ...
            If txtFiltro.Text = String.Empty Then
                MsgBox("Debe seleccionar un cliente para poder generar el reporte.", MsgBoxStyle.Information)
                estado = False
                Exit Try
            End If
            Filtro = txtFiltro.Text
