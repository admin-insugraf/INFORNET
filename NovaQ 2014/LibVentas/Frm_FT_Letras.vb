...
Imports LibReportes
Public Class Frm_FT_Letras
    Dim reporteBL As ClsBuscar
    Dim crystalBL As ClsReporte
    Dim dtImprimir As DataTable
    Private Sub Frm_FT_Letras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ImprimirReporte()
        ...
        Try
            ...
            dtImprimir = reporteBL.Get_Reporte_FT_Letras(IIf(rdb_pendientes.Checked, 1, IIf(rdb_canjeados.Checked, 2, IIf(rdb_ambos.Checked, 3, 0))), txtClienteInicial.Text.Trim, dtpfechaInicio.Value.ToString("dd/MM/yyyy"), dtpfechaFin.Value.ToString("dd/MM/yyyy"))
            If dtImprimir.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("REP_FT_LETRAS.rpt", dtImprimir, "", "", "XVEN1;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "XVEN2;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"), "RUC;" & dtDatosCompany.Rows(0).Item("VAT_REGISTRATION").ToString, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString)
            Else
