...
Public Class FrmRegVentasCobranza
    ...
    Private Sub FrmRegVentasCobranza_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Select Case _TipoReporte
                Case 1
                    ...
                    dt_tmp = reporteBL.Get_ImprimirRegistroVentasCobranza(NombreStore, _fechaInicial, _fechaFinal, _TipoReporte, idTipoDoc)
                    ...
                    If dt_tmp.Rows.Count() <> 0 Then
                        ...
                        crystalBL.Muestra_Reporte("REP_REGVENTAS_COBRANZA.rpt", "", "", "", "XVEN1;" & _fechaInicial, "XVEN2;" & _fechaFinal, "XPLAZO1;" & txtplazo1.Text, "XPLAZO2;" & txtplazo2.Text, "XPLAZO3;" & txtplazo3.Text, "XPLAZO4;" & txtplazo4.Text, "XPLAZOMAS;" & txtplazo5.Text, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString)
                    Else
                ...
                Case 2
                    ...
                    If dt_tmp.Rows.Count() <> 0 Then
                        ' crystalBL.Muestra_Reporte("rpt_registro_ventas.rpt", dt_tmp, "", "", "@FECHA_INICIAL;" & _fechaInicial, "@FECHA_FINAL;" & _fechaFinal, "@PERIODO;" & dtpfechaInicio.Value.ToString("MMMM - yyyy").ToUpper, "@TIPOS_DOC;" & idTipoDoc)
                        crystalBL.Muestra_Reporte("REP_REGVENTAS_COBRANZA_DETALLADO.rpt", "", "", "", "XVEN1;" & _fechaInicial, "XVEN2;" & _fechaFinal, "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString)
                    Else
                        MsgBox("No hay informacion disponible para Mostrar en el Reporte", MsgBoxStyle.Information)
                    End If
            End Select
    ...
    Private Sub BackgroundWorker1_DoWork(sender As Object, e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        Try
            ...
            dt_tmp = New DataTable
            dt_tmp = reporteBL.Get_ImprimirRegistroVentasCobranza(NombreStore, dtpfechaInicio.Value.ToString("dd/MM/yyyy"), dtpfechaFin.Value.ToString("dd/MM/yyyy"), "3")
            ...
            If dt_tmp.Rows.Count() <> 0 Then
                ...
                e.Result = clase_excel.ExportarSQLExcel_Rep_Reg_Ventas_Cobranza_Diario(dt_tmp, Ruta, Archivo)
