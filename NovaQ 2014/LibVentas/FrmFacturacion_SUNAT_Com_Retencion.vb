...
Public Class FrmFacturacion_SUNAT_Com_Retencion
    ...
    Private Sub FrmFacturacion_SUNAT_Com_Retencion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub DocumentosFactura()
        Try
            ...
            dtDocumentoFactura = clsFacturaBl.get_DatosGeneralesFacturacion_SUNAT_Comp_Retencion(dtpfechaInicial.Value.ToString("dd/MM/yyyy"), dtpfechafinal.Value.ToString("dd/MM/yyyy"), _
    ...
    Private Sub Formato_Grilla()
        If dtDocumentoFactura.Rows.Count() <> 0 Then
            ...
            dgvDocumentosFactura2.Columns("CRESUMEN").Visible = False
            dgvDocumentosFactura2.Columns("OPE. GRABADAS").Visible = False
            dgvDocumentosFactura2.Columns("OPE. INAFECTAS").Visible = False
            dgvDocumentosFactura2.Columns("OPE. EXONERADAS").Visible = False
            dgvDocumentosFactura2.Columns("IGV").Visible = False
            dgvDocumentosFactura2.Columns("ORIGEN").Visible = False
        End If
        ...
        Try
            ...
            For i As Integer = 0 To dtDocumentoFactura.Rows.Count() - 1
                ...
                With cabeceraBE
                    ...
                    .ORIGEN = dtDocumentoFactura.Rows(i).Item("ORIGEN").ToString
                End With
                ls_det.Add(cabeceraBE)
            Next

            If cabeceraBL.GuardarFactura_Actualiza_SUNAT_Comp_Retencion(ls_det) = False Then
    ...
    Private Sub btn_ver_pdf_Click(sender As Object, e As EventArgs) Handles btn_ver_pdf.Click
        ...
        If Strings.Left(Ref_NUMBER_SERIE, 1) = "R" Or Strings.Left(Ref_NUMBER_SERIE, 1) = "B" Then
            Dim _fecha_doc As Date
            _fecha_doc = dgvDocumentosFactura2.CurrentRow.Cells("FECHA EMISION").Value

            'VERIFICAMOS SI SE ENCUENTRA EN LA RUTA DEL SERVIDOR
            StrNomArchivo_PDF = Ruta_FE_Verificacion() & "PDF\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".pdf"
            ...
            Else
                StrNomArchivo_PDF = Ruta_FE() & "\Output\Process\PDF\" & LibComunVar.ClsVarComun.RucEmpresa & "\" & _fecha_doc.Year.ToString & "\" & Format(_fecha_doc.Month, "00") & "\" &
                                    Format(_fecha_doc.Day, "00") & "\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" &
                ...
                If File.Exists(StrNomArchivo_PDF) Then
                    If Copiar_Archivos(StrNomArchivo_PDF, Ruta_FE_Verificacion() & "PDF") = True Then
                        ...
                        Else
                            Dim msj As String = ""
                            msj = String.Empty
                            msj = "No existe el archivo " & vbCrLf & "" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".pdf"
            ...
            StrNomArchivo_XML = Ruta_FE_Verificacion() & "XML\" & LibComunVar.ClsVarComun.RucEmpresa & _
                                "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".xml"
            ...
            If File.Exists(StrNomArchivo_XML) = False Then
                StrNomArchivo_XML = Ruta_FE() & "\Output\Process\XML\" & LibComunVar.ClsVarComun.RucEmpresa & "\" &
                            ...
                            Format(_fecha_doc.Day, "00") & "\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" &
                ...
                Else
                    Dim msj As String = ""
                    msj = String.Empty
                    msj = "No existe el archivo " & vbCrLf & "" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".xml"
                    MsgBox(msj, MsgBoxStyle.Information)
                    Exit Sub
                End If
            End If
    ...
    Private Sub btn_ver_cdr_Click(sender As Object, e As EventArgs) Handles btn_ver_cdr.Click
        ...
        _frm_cdr._tipo_doc_electronico = "CR"
        _frm_cdr.ShowDialog()
    End Sub
    ...
    Private Sub btn_reenvio_email_Click(sender As Object, e As EventArgs) Handles btn_reenvio_email.Click
        ...
        Try
            ...
            Ref_NUMBER_DOCUMENT = dgvDocumentosFactura2.CurrentRow.Cells("NUMERO").Value
            _fecha_doc = dgvDocumentosFactura2.CurrentRow.Cells("FECHA EMISION").Value
            _EMAIL_RECEPCIONANTE = dgvDocumentosFactura2.CurrentRow.Cells("EMAIL").Value

            If Strings.Left(Ref_NUMBER_SERIE, 1) = "R" Then

                'BUSCAMOS LOS ARCHIVOS PDF Y XML DESDE LA RUTA GENERAL DEL SERVIDOR
                'PDF
                StrNomArchivo_PDF = Ruta_FE_Verificacion() & "PDF\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & _
                                    Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".pdf"
                ...
                'XML
                StrNomArchivo_XML = Ruta_FE_Verificacion() & "XML\" & LibComunVar.ClsVarComun.RucEmpresa & "-20" & _
                ...
                'CDR
                StrNomArchivo_CDR = Ruta_FE_Verificacion() & "CDR\R-" & LibComunVar.ClsVarComun.RucEmpresa & "-20" & _
                                    "-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".xml"
                If File.Exists(StrNomArchivo_CDR) = False Then
                    StrNomArchivo_CDR = Ruta_FE() & "\Output\Send\CDR\" & LibComunVar.ClsVarComun.RucEmpresa & "\R-" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" &
                                        Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".xml"
                    ...
                    Else
                        Dim msj As String = ""
                        msj = String.Empty
                        msj = "No existe el archivo " & vbCrLf & "" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".cdr"
                        MsgBox(msj, MsgBoxStyle.Critical)
                        Exit Sub
                    End If
                End If
                ...
                If File.Exists(StrNomArchivo_PDF) = False Then
                    ...
                    Exit Sub
                Else
                    StrNomArchivo_XML = Ruta_FE_Verificacion() & "XML\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".xml"
                    If File.Exists(StrNomArchivo_XML) = False Then
                        Dim msj As String = ""
                        msj = String.Empty
                        msj = "No existe el archivo " & vbCrLf & "" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".xml"
                        ...
                        Exit Sub
                    Else
                        StrNomArchivo_CDR = Ruta_FE_Verificacion() & "CDR\R-" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Ref_NUMBER_DOCUMENT), "00000000") & ".xml"
                        If File.Exists(StrNomArchivo_CDR) = False Then
                            Dim msj As String = ""
                            msj = String.Empty
                            msj = "No existe el archivo " & vbCrLf & "" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".cdr"
                        ...
                        Else
                            ...
                            envio_mail._nombre_documento = "20-" & Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000")
                            ...
                            envio_mail._nombre_tipo_documento = "COMPROBANTE DE RETENCION ELECTRÓNICA"
    ...
    Private Sub btn_reenviar_doc_sunat_Click(sender As Object, e As EventArgs) Handles btn_reenviar_doc_sunat.Click
        ...
        Try
            ...
            Ref_NUMBER_DOCUMENT = dgvDocumentosFactura2.CurrentRow.Cells("NUMERO").Value
            estado_facturacion = dgvDocumentosFactura2.CurrentRow.Cells("ESTADO FACTURACION").Value
            numero_ticket = dgvDocumentosFactura2.CurrentRow.Cells("CRESUMEN").Value
            ...
            origen = dgvDocumentosFactura2.CurrentRow.Cells("ORIGEN").Value
            ...
            If MessageBox.Show("¿Desea Re-enviar el documento: " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " a SUNAT?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                If Generar_XML_Comprobante_retencion(numero_ticket, STRmontotexto, nombre_xml, nombre_pdf, origen) = False Then
                    MsgBox("El documento " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " no genero el archivo XML." & Chr(13) & "Realizar la revisión.", MsgBoxStyle.Critical, "Sistemas")
                Else
                    Dim StrNomArchivo_XML As String = ""
                    Dim StrNomArchivo_PDF As String = ""
                    ...
                    Else
                        ...
                        StrNomArchivo_XML = Ruta_FE() & "\Output\Process\XML\" & LibComunVar.ClsVarComun.RucEmpresa & "\" &
                            ...
                            Format(LibComunVar.ClsVarComun.FechaSistema.Day, "00") & "\" & LibComunVar.ClsVarComun.RucEmpresa & "-20-" &
                            Ref_NUMBER_SERIE & "-" & Format(CInt(Strings.Right(Ref_NUMBER_DOCUMENT, 7)), "00000000") & ".xml"
    ...
    Private Function Generar_XML_Comprobante_retencion(ByVal Numero_compra As String, ByVal _monto_texto As String, ByRef _nombre_xml As String, ByRef _nombre_pdf As String, ByVal _origen As String) As Boolean
        Try
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            If _origen = "COMPRAS" Then
    ...
    Private Sub btn_comunicacion_baja_Click(sender As Object, e As EventArgs) Handles btn_comunicacion_baja.Click
        ...
        Try
            ...
            If CInt(dgvDocumentosFactura2.CurrentRow.Cells("DIAS").Value) > 7 Then
                Me.Cursor = Cursors.Default
                MsgBox("No aplica el Proceso de Re-envio a SUNAT, por superar el limite de días habiles.", MsgBoxStyle.Exclamation)
                Exit Sub
            End If
            ...
            If MessageBox.Show("¿Desea enviar la COMUNICACION DE BAJA del documento: " & Chr(13) & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " a SUNAT?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                cabeceraBL = New ClsOperaciones.RECEIVABLE
                ID_COMUNICACION_BAJA_ = ""
                ID_COMUNICACION_BAJA_CDR = ""
                If Generar_XML_Comunicacion_Baja_CR(Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT, Date.Now.ToString("dd/MM/yyyy"), _
                                                     ID_COMUNICACION_BAJA_, ID_COMUNICACION_BAJA_CDR, origen) = False Then
                    Me.Cursor = Cursors.Default
                ...
                Else
                    ...
                    StrNomArchivo_XML = Ruta_FE() & "\InputXML\RR-" & ID_COMUNICACION_BAJA_
                    ...
                    Else
                        StrNomArchivo_XML = Ruta_FE() & "\Output\Process\XML\" & LibComunVar.ClsVarComun.RucEmpresa & "\" &
                                            ...
                                            "-RR-" & ID_COMUNICACION_BAJA_CDR

                        System.Threading.Thread.Sleep(2000)
                        If File.Exists(StrNomArchivo_XML) Then
                            If Copiar_Archivos(StrNomArchivo_XML, Ruta_FE_Verificacion() & "XML") = False Then
                                MsgBox("ERROR:" & Chr(13) & "El documento RR-" & ID_COMUNICACION_BAJA_CDR & Chr(13) & _
                                       "no se pudo copiar a la carpeta de destino. Verifique!!!", MsgBoxStyle.Information, "UBL 2.1")
                            Else
                                DocumentosFactura()
                                Me.Cursor = Cursors.Default
                            ...
                            End If
                        Else
                            MsgBox("No existe el documento RR-" & ID_COMUNICACION_BAJA_CDR & " . Verifique!!!", MsgBoxStyle.Information, "UBL 2.1")
                        End If
                    End If
                End If
            End If
    ...
    Private Function Generar_XML_Comunicacion_Baja_CR(ByVal TipoDoc As String, ByVal SerieDoc As String, ByVal NumDoc As String, ByVal Fecha_baja As String, _
                                                   ByRef ID_COMUNICACION_BAJA_ As String, ByRef ID_COMUNICACION_BAJA_CDR As String, ByVal ORIGEN As String) As Boolean
        Try
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            If ORIGEN = "COMPRAS" Then
                If clsFacturaBl.Generar_XML_Comunicacion_Baja_CR(TipoDoc, SerieDoc, NumDoc, Ruta_FE() & "\InputXML", Fecha_baja, ID_COMUNICACION_BAJA_, ID_COMUNICACION_BAJA_CDR) Then
                    Return True
                Else
                    Return False
                End If
            ElseIf ORIGEN = "PAGOS" Then
                If clsFacturaBl.Generar_XML_Comunicacion_Baja_CR_Pagos(TipoDoc, SerieDoc, NumDoc, Ruta_FE() & "\InputXML", Fecha_baja, ID_COMUNICACION_BAJA_, ID_COMUNICACION_BAJA_CDR) Then
                    Return True
                Else
                    Return False
                End If
    ...
    Private Function GuardarFacturacion_Estado_Sunat() As Boolean
        ...
        Try
            ...
            If cabeceraBL.GuardarFactura_Actualiza_Estado_Cpe_SUNAT_Comp_retencion(ls_det) = False Then
                MsgBox("Hubo un Error en la Actualización de los documentos Electronicos", MsgBoxStyle.Critical)
                indicadorF = False
                Exit Try
            End If
