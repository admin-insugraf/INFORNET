...
Public Class CX_02
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pFechas() As CrystalDecisions.[Shared].IParameterField
        Get
