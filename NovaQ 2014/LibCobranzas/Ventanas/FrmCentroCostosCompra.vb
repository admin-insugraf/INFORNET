...
Public Class FrmCentroCostosCompra
    Dim bol_nuevo As Boolean = False
    Dim dtv As DataView
    Dim STRorden As String = String.Empty
    Dim tipoPagoBL As ClsOperaciones.TERMS
    Dim dtdetalles As DataTable
    Private Sub FrmCentroCostosCompra_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Cargar_Datos()
    ...
    Private Sub Cargar_Datos()
        ...
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Centros_Costos()
    ...
    Private Function GeneracionCodigo(ByVal Tipo As String) As Boolean
        ...
        Try
            ...
            dtdetalles = tipoPagoBL.GeneracionCodigoCentroCostos()
            If dtdetalles.Rows.Count() <> 0 Then
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        codigo = String.Format("{0:000}", CInt(codigo))
        With termsBE
            .ID = codigo
        ...
        If bol_nuevo Then
            termsBL.Insert_Centro_Costos_Compras(termsBE)
            Call Avisar("Registro insertado correctamente!")
        Else
            termsBL.Update_Centros_Costos_Compras(termsBE)
            Call Avisar("Registro modificado correctamente!")
        End If
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            ...
            termsBL.Delete_Centros_Costos(termsBE.ID)
            termsBE = Nothing
            termsBL = Nothing
            Call Cargar_Datos()
    ...
    Private Sub mtb_dias_KeyDown(sender As Object, e As KeyEventArgs)
        If e.KeyCode = Keys.Enter Then
            btn_grabar.Select()
        End If
    End Sub
