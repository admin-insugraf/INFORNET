...
Public Class FrmFacturacion_Tienda
    ...
    Dim STRordenCliente_pedidos As String = String.Empty
    ...
    Dim monto_scotiabank As Double, monto_interbank As Double
    ...
    Dim num_operacion_scotiabank As String
    Dim num_operacion_interbank As String
    ...
    Dim _nueva_cantidad As Double = 0
    Dim _tamaño As Double = 0
    ...
    Private Sub FrmFacturacion_Tienda_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dtValidacion = monedaBL.get_Valida_Sock()
        If dtValidacion.Rows.Count > 0 Then
            _AFECTA_STOCK = dtValidacion.Rows(0).Item("VALIDA_STOCK").ToString
        End If
    ...
    Public Sub Botonera_Estado_Cambiar(ByVal Opcion As Boolean)
        If Opcion Then
            ...
            btn_rep_arqueo_caja.Enabled = False
            btn_descargar_archivos.Enabled = False
            btn_cierre_ventas.Enabled = False
        ...
        Else
            ...
            btn_rep_arqueo_caja.Enabled = True
            btn_descargar_archivos.Enabled = True
            btn_cierre_ventas.Enabled = True
            btnGrabar.Enabled = False
    ...
    Public Sub GenerarColummnaDataTable()
        Try
            ...
            dtdetalleArticuloPrincipal.Columns.Add("CANTIDAD_EQUIVALENTE", Type.GetType("System.Double")) '39
            dtdetalleArticuloPrincipal.Columns.Add("TAMAÑO", Type.GetType("System.Double")) '40
            dtdetalleArticuloPrincipal.Columns.Add("NUEVA_CANTIDAD", Type.GetType("System.Double")) '41
            ...
            dgvDetalle.Columns("TAMAÑO").Visible = False '.HeaderText = "Item Referencia"
            dgvDetalle.Columns("NUEVA_CANTIDAD").Visible = False '.HeaderText = "Item Referencia"
            dgvDetalle.Columns("CANTIDAD_EQUIVALENTE").Visible = False '.HeaderText = "Item Referencia"
            ...
            dgvDetalle.Columns("OBSERVACIONES").DisplayIndex = 11
    ...
    Private Sub NuevaVenta()
        Try
            ...
            If dtCabeceraFact.Rows.Count > 0 Then
                If LibComunVar.ClsVarComun.PUNTO_VENTA = "" Then
                    txtPtoVenta.Text = dtCabeceraFact.Rows(0).Item("SALES_PLACE_ID").ToString
                Else
                    txtPtoVenta.Text = LibComunVar.ClsVarComun.PUNTO_VENTA
                End If
                ...
                chk_venta_cortesia.Checked = False
                _factor = 0
                _tamaño = 0
                _nueva_cantidad = 0
                btn_cal_cantidad.Visible = False
    ...
    Private Sub btnNuevo_Click(sender As Object, e As EventArgs) Handles btnNuevo.Click
        Try
            ...
            dtTipoCamb_tc = cl.Verifircar_Planilla_Caja_chica_2(LibComunVar.ClsVarComun.FechaSistema.ToString("dd/MM/yyyy"), LibComunVar.ClsVarComun.USUARIO)
            If dtTipoCamb_tc.Rows.Count() = 0 Then
                MsgBox("No se aperturo Caja Chica para estos datos:" & Chr(13) & "Fecha: " & LibComunVar.ClsVarComun.FechaSistema.ToString("dd/MM/yyyy") & Chr(13) & "Usuario:" & LibComunVar.ClsVarComun.USUARIO & Chr(13) & "Debe aperturar Caja Chica.", MsgBoxStyle.Exclamation, "Sistemas")
                pnlNuevaPlanilla.Visible = True
                lbl_nombre_usuario.Text = LibComunVar.ClsVarComun.USUARIO
                dtp_fec_nueva_pla.Value = Date.Now
                txt_saldo_inicial_caja.Text = "0"
                ToolStrip1.Enabled = False
                pnlPrincipal.Enabled = False
                txt_saldo_inicial_caja.Select()
                Me.Cursor = Cursors.Default
            Else
                Botonera_Estado_Cambiar(True)
                Flag_Verificar = True
        ...
        Try
            ...
            If dtCabeceraFact.Rows.Count() <> 0 Then
                For i As Integer = 0 To dtCabeceraFact.Rows.Count() - 1
                    ...
                    txt_numero_comprobante.Visible = True
                    txt_numero_comprobante.Text = DOCUMENT_ID & " " & NUMBER_SERIE & "-" & NUMBER_DOCUMENT
                    ...
                    dtpFechaFactura_vcto.Text = dtCabeceraFact.Rows(i).Item("CADUCATE_DATE").ToString
    ...
    Private Function CodigoNumeracionGuiaRemision() As Boolean
        ...
        Try
            Dim frmTipoNum As New FrmTipoNumeracion_Fact_rapida
    ...
    Private Function CodigoNumeraciondocumentoGeneral() As Boolean
        ...
        Try
            ...
            num_operacion_scotiabank = ""
            num_operacion_interbank = ""
            modo_pago = ""
            forma_pago = ""
            ...
            monto_scotiabank = frmTipoNum.monto_scotiabank
            monto_interbank = frmTipoNum.monto_interbank
            ...
            num_operacion_scotiabank = frmTipoNum.num_operacion_scotiabank
            num_operacion_interbank = frmTipoNum.num_operacion_interbank
    ...
    Private Function GuardarFacturacion() As Boolean
        ...
        Try
            ...
            With cabeceraBE
                ...
                .POINT_BOARD = 0
                .POINT_ARRIVAL = 0
                .RECEIVABLE_TYPE = IIf(chk_venta_cortesia.Checked, "FO", cboTipoDoc.Text)
                ...
                .TERMS_ID = txtFormaPago.Text 'forma_pago
                .MODO_PAGO = modo_pago
                ...
                Else
                    If cboTipoDoc.Text = "NC" Or cboTipoDoc.Text = "ND" Then
                        .DOCUMENT_REF = txt_tipo_doc_ref.Text
                        .SERIE_REF = txt_serie_ref_doc.Text
                        .FECHA_REFERENCIA = dtp_fec_doc_ref.Value.ToString("dd/MM/yyyy")
                        If rbFacturaGuiaVenta.Checked Or rbFacturaRepMedico.Checked Then
                            .NUMBER_REF = "GUIAS"
                        Else
                            .NUMBER_REF = txt_numero_ref_doc.Text
                        End If
                    Else
                        .DOCUMENT_REF = ""
                        .SERIE_REF = ""
                ...
                .TIPO_NOTA_ELECTRONICA = txt_tip_nota_electronica.Text
                .DESCRIPCION_TIPO_NOTA_ELECTRONICA = txt_desc_tipo_nota_electronica.Text
                ...
                .MONTO_SCOTIABANK = monto_scotiabank
                .MONTO_INTERBANK = monto_interbank

                If Factura_Pedido Then
                    .STATUS_PEDIDO = "PED"
                Else
                    .STATUS_PEDIDO = ""
                End If
            ...
            For i As Integer = 0 To dtdetalleArticuloPrincipal.Rows.Count() - 1
                ...
                With detalle
                    ...
                    .QTY_EQUIVALENTE = dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD_EQUIVALENTE")
                    .TAMAÑO = dtdetalleArticuloPrincipal.Rows(i).Item("TAMAÑO")
                    .NUEVA_CANTIDAD = dtdetalleArticuloPrincipal.Rows(i).Item("NUEVA_CANTIDAD")
            ...
            Next
            'CLIENTES
            If chk_venta_cortesia.Checked = False And (Factura_Pedido = False) Then
                With carteraBE
                    .CUSTOMER_ID = txtCodCliente.Text.Trim
                    .DOCUMENT_ID = cboTipoDoc.Text
                    ...
                    If rbFacturaDirecta.Checked = True Or chk_venta_cortesia.Checked = True Then
            ...
            If Tipo_cancelacion <> "Credito" And Factura_Pedido = False Then
                ...
                If monto_mastercard > 0 Then 'bbva
                    planilladetBE = New ClsEntidades.RECEIVABLE_LIST_LINE
                    With planilladetBE
                        .ID = ""
                        .ITEM = 0
                ...
                If monto_diners_club > 0 Then 'yape
                    planilladetBE = New ClsEntidades.RECEIVABLE_LIST_LINE
                    With planilladetBE
                        .ID = ""
                        .ITEM = 0
                ...
                If monto_american_expres > 0 Then 'plin
                    planilladetBE = New ClsEntidades.RECEIVABLE_LIST_LINE
                    With planilladetBE
                        .ID = ""
                        .ITEM = 0
                ...
                If monto_scotiabank > 0 Then 'SCOTIABANK
                    planilladetBE = New ClsEntidades.RECEIVABLE_LIST_LINE
                    With planilladetBE
                        .ID = ""
                        .ITEM = 0
                        ...
                        .BANK_DESCRIPTION = ""
                        .DOC_REF = "TB"
                        .NUM_REF = num_operacion_scotiabank
                        .BANK_BUSSINESS_ID = ""
                        .ACCOUNT_BANK_CHECK = ""
                    ...
                    ls_detalle.Add(planilladetBE)
                End If
                If monto_interbank > 0 Then 'INTERBANK
                    planilladetBE = New ClsEntidades.RECEIVABLE_LIST_LINE
                    With planilladetBE
                        .ID = ""
                        .ITEM = 0
                        ...
                        .BANK_DESCRIPTION = ""
                        .DOC_REF = "TB"
                        .NUM_REF = num_operacion_interbank
                        .BANK_BUSSINESS_ID = ""
                        .ACCOUNT_BANK_CHECK = ""
            ...
            If Factura_Pedido = False And chk_venta_sin_Descargo.Checked = False Then
                If rbFacturaDirecta.Checked = True Or rbFacturaExistencias.Checked = True Or rb_facturar_pedido.Checked = True Or chk_facturar_obsequio.Checked = True Or chk_venta_cortesia.Checked = True Then
                    'la parte de almacen
                    With alm_cabBE
                        .WAREHOUSE_ID = txtAlmacen.Text
                        .DOCUMENT_ID = cboTipoDoc.Text
                        ...
                        Else
                            .TYPE_TRANS = "S"
                        End If
                        .TRANS_ID = IIf(chk_venta_cortesia.Checked, "FO", "FT")
                    ...
                    For i As Integer = 0 To dtdetalleArticuloPrincipal.Rows.Count() - 1
                        ...
                        With alm_detBE
                            ...
                            If dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD_EQUIVALENTE") <> 0 Then
                                .QTY = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD_EQUIVALENTE"))
                                .QTY_REF = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD"))
                                .TAMAÑO = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("TAMAÑO"))
                                .NUEVA_CANTIDAD = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("NUEVA_CANTIDAD"))
                            Else
                                .QTY = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD"))
                                .QTY_REF = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("CANTIDAD_EQUIVALENTE"))
                                .TAMAÑO = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("TAMAÑO"))
                                .NUEVA_CANTIDAD = Math.Abs(dtdetalleArticuloPrincipal.Rows(i).Item("NUEVA_CANTIDAD"))
                            End If
                            .QTY_DLV = 0
            ...
            If cabeceraBL.GuardarFactura(cabeceraBE, ls_det, carteraBE, alm_cabBE, ls_det_alm, ls_detalle, cabeceraBE.CURRENCY_ID, CDate(dtpFechaFactura.Value).ToShortDateString,
                                         TipoNumeracion, cboTipoDoc.Text, Factura_Pedido, ListaDocCliente,
                                         ...
                                         IIf(rb_facturar_devolucion.Checked = True, True, False), TIPO_DEV, NUM_DEV, Tipo_cancelacion) = False Then
    ...
    Private Sub Limpiar()
        ...
        dtpFechaFactura_vcto.Value = Date.Now
        txtCodCliente.Clear()
        txtRucDni.Clear()
        ...
        txtcantidad_equivalente.Text = "0"
        chk_venta_cortesia.Checked = False
        _factor = 0
        Factura_Pedido = False
        txt_numero_comprobante.Text = ""
        txt_numero_comprobante.Visible = False
    End Sub
            ...
            ElseIf _GENERA_FACTURA_ELECTRONICA = "S" Then
                ...
                If GuardarFacturacion() = True Then
                    ...
                    If cboMoneda.SelectedValue = "MN" Then
                        If chk_venta_cortesia.Checked Then
                    ...
                    '***************************
                    If Generar_XML_Factura_Guia(cboTipoDoc.Text, cboSerieDoc.Text, Strings.Right(NumeracionFacturacion, 7), STRmontotexto, "SI", "1") = False Then
        ...
        Try
            ...
            If cboopcionesBusqueda.SelectedIndex = 3 Then 'busqueda rapida
                ...
                Else
                    ...
                    dtv = New DataView
                    dtDocumentoFactura = clsFacturaBl.get_Busqueda_Rapida(txtFiltro.Text.Trim, IIf(cboOpcionTipoDoc.SelectedIndex = 0, "", cboOpcionTipoDoc.Text), LibComunVar.ClsVarComun.USUARIO)
                    dgvDocumentosFactura.DataSource = Nothing
            ...
            ElseIf cboopcionesBusqueda.SelectedIndex = 4 Then ' busqueda por serie
                ...
                Else
                    ...
                    dtDocumentoFactura = New DataTable
                    dtv = New DataView
                    dtDocumentoFactura = clsFacturaBl.get_Busqueda_Por_Serie(txtFiltro.Text.Trim, IIf(cboOpcionTipoDoc.SelectedIndex = 0, "", cboOpcionTipoDoc.Text), dtpfechaInicial.Value.ToString("dd/MM/yyyy"), dtpfechafinal.Value.ToString("dd/MM/yyyy"), LibComunVar.ClsVarComun.USUARIO)
                    dgvDocumentosFactura.DataSource = Nothing
                    If dtDocumentoFactura.Rows.Count() <> 0 Then
                        dtv = dtDocumentoFactura.DefaultView
                        dgvDocumentosFactura.DataSource = dtv
            ...
            Else
                ...
                dtDocumentoFactura = clsFacturaBl.get_DatosGeneralesFacturacion_Tienda(dtpfechaInicial.Value.ToString("dd/MM/yyyy"), dtpfechafinal.Value.ToString("dd/MM/yyyy"),
                                                                                cboopcionesBusqueda.SelectedIndex, IIf(cboOpcionTipoDoc.SelectedIndex = 0, "", cboOpcionTipoDoc.Text), LibComunVar.ClsVarComun.USUARIO)
                dgvDocumentosFactura.DataSource = Nothing
                If dtDocumentoFactura.Rows.Count() <> 0 Then
                    dtv = dtDocumentoFactura.DefaultView
                    dgvDocumentosFactura.DataSource = dtv
                    ...
                    dgvDocumentosFactura.Columns("IS_CLOSED").Visible = False
    ...
    Private Function Cierre_Ventas(ByVal _FECHA As String, ByVal _USUARIO As String, ByVal _SALDO_FINAL As Double,
        ...
        Try
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            If clsFacturaBl.Cierre_Ventas(_FECHA, _USUARIO, _SALDO_FINAL, _SALDO_FINAL_VISA, _SALDO_FINAL_MASTER,
                                          _SALDO_FINAL_DINERS, _SALDO_FINAL_AMERICAN_EXPRESS,
                                          _SALDO_FINAL_BCP, _SALDO_FINAL_BBVA, _SALDO_FINAL_YAPE, _SALDO_FINAL_PLIN, _COBRO_VENTA_ANTERIOR,
                                          _SALDO_FINAL_SCOTIABANK, _SALDO_FINAL_INTERBANK) = False Then
                estado = False
            End If
        Catch ex As Exception
            estado = False
    ...
    Private Function Actualizar_Cantidad_Comprobante(ByVal _documento As String, ByVal _serie As String, ByVal _numero As String) As Boolean
        Dim estado As Boolean = True
        Try
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            If clsFacturaBl.Actualizar_Cantidad_Comprobante(_documento, _serie, _numero) = False Then
                estado = False
            End If
        Catch ex As Exception
            estado = False
    ...
    Private Sub btnAnular_Click(sender As Object, e As EventArgs) Handles btnAnular.Click
        ...
        Try
            ...
            Store = String.Empty
            Store = "FACT_SP_S_R_VERIFICAR_CIERRE"
            If VerificarDocumentos(Store, Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT) = False Then
                Me.Cursor = Cursors.Default
                msj = String.Empty
                msj = "EL Documento: " & Ref_DOCUMENT_ID & " - " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & vbCrLf & " esta cerrado, no se puede Anular."
                ...
                Else
                    ...
                    Else
                        If _DOCUMENT_ID = "PF" Then
                            Dim codigo As String = String.Empty
                            codigo = "1" ' InputBox("Digite 1 para imprimir en formato TK" & Chr(13) & "Digite 2 para imprimir en formato A4")
    ...
    Private Sub Ayuda_Clientes(Optional ByVal _CodigoCliente As String = "")
        Try
            ...
            dtpFechaFactura_vcto.Value = Get_FormaPagoFechaVencimiento()
        ...
        Try
            ...
            If cboTipoDoc.Text = "NC" Or cboTipoDoc.Text = "ND" Then
                ...
                If Flag_Ref = False Then
                    MsgBox("Debe ingresar el Documento de Referencia.", MsgBoxStyle.Exclamation)
                    estado = False
                    Button5.Focus()
                    Exit Try
                End If
                        ...
                        If chkSinIGV.Checked = False Then 'si el precio contiene el IGV
                            ...
                            If dtIgvArticulo.Rows(0).Item("IS_VAT").ToString = False Then
                                If cboTipoDoc.Text = "NC" Then
                                    ...
                                    Monto = Val(Format((Monto / (1 + TasaIgv)) / (1 + TasaISC), "0.00000000"))
    ...
    Private Sub btn_agregar_carrito_Click(sender As Object, e As EventArgs) Handles btn_agregar_carrito.Click
        ...
        If Flag_Modo_Edicion = False Then
            ...
            If CDbl(txtcantidad.Text) > 0 Then
                ...
                row("CANTIDAD_EQUIVALENTE") = txtcantidad_equivalente.Text
                row("TAMAÑO") = _tamaño
                row("NUEVA_CANTIDAD") = _nueva_cantidad
                ...
                row("TOTAL_INICIAL") = Math.Round(row("CANTIDAD") * row("PRECIO_INICIAL"), 8)
    ...
    Private Function ValidacionesGenerales_Detalle() As Boolean
        ...
        Try
            ...
            If txtcantidad_equivalente.Text = String.Empty Then txtcantidad_equivalente.Text = "0"
            ...
            If _AFECTA_STOCK = "S" Then
                If CDbl(txtcantidad_equivalente.Text) > 0 Then
                    If CDbl(IIf(txtStock.Text = "", 0, txtStock.Text)) < CDbl(txtcantidad_equivalente.Text) Then
    ...
    Private Sub dgv_lista_productos_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_lista_productos.CellClick
        ...
        Try
            ...
            _factor = dgv_lista_productos.CurrentRow.Cells("FACTOR").Value
            txtcantidad.Text = "0"
            txtcantidad_fraccion.Text = "0"
            txtcantidad_equivalente.Text = "0"
            If dgv_lista_productos.CurrentRow.Cells("ES_ANILLO").Value = "SI" Then
                btn_cal_cantidad.Visible = True
            Else
                btn_cal_cantidad.Visible = False
            End If
            txtcantidad.Select()
    ...
    Private Sub Button12_Click(sender As Object, e As EventArgs) Handles Button12.Click
        ...
        '        If txt_bcp.Text = "" Then txt_bcp.Text = "0"
        '        If txt_bbva.Text = "" Then txt_bbva.Text = "0"
        '        If txt_yape.Text = "" Then txt_yape.Text = "0"
        '        If txt_plin.Text = "" Then txt_plin.Text = "0"
        ...
        '                         CDbl(txt_bcp.Text), CDbl(txt_bbva.Text), CDbl(txt_yape.Text), CDbl(txt_plin.Text)) = False Then
        ...
        Try
            If MessageBox.Show("¿Desea generar el Cierre de Ventas?" & Chr(13) & "Fecha: " & dtp_fecha_cierre_ventas.Value.ToString("dd/MM/yyyy") & Chr(13) & "Usuario: " & LibComunVar.ClsVarComun.USUARIO, "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                If txt_saldo_final.Text = "" Then txt_saldo_final.Text = "0"
                If TxEfeDol.Text = "" Then TxEfeDol.Text = "0"
                If txt_bcp.Text = "" Then txt_bcp.Text = "0"
                If txt_bbva.Text = "" Then txt_bbva.Text = "0"
                If txt_yape.Text = "" Then txt_yape.Text = "0"
                If txt_plin.Text = "" Then txt_plin.Text = "0"
                If txt_scotiabank.Text = "" Then txt_scotiabank.Text = "0"
                If txt_interbank.Text = "" Then txt_interbank.Text = "0"
                If txt_cobro_venta_anterior.Text = "" Then txt_cobro_venta_anterior.Text = "0"

                If Cierre_Ventas(dtp_fecha_cierre_ventas.Value.ToString("dd/MM/yyyy"),
                                 LibComunVar.ClsVarComun.USUARIO, CDbl(txt_saldo_final.Text),
                                 CDbl(TxEfeDol.Text), CDbl(0), CDbl(0), CDbl(0),
                                 CDbl(txt_bcp.Text), CDbl(txt_bbva.Text), CDbl(txt_yape.Text),
                                 CDbl(txt_plin.Text), CDbl(txt_cobro_venta_anterior.Text),
                                 CDbl(txt_scotiabank.Text), CDbl(txt_interbank.Text)) = False Then
                    MsgBox("Hubo un error, no se completo el Proceso de Cierre de Ventas para la fecha elegida.", MsgBoxStyle.Exclamation)
                    Me.Cursor = Cursors.Default
                    Exit Sub
                Else
                    ...
                    dtImprimir = reporteBL.Reporte_Cierre_Ventas_Detallado(dtp_fecha_cierre_ventas.Value.ToString("dd/MM/yyyy"), LibComunVar.ClsVarComun.USUARIO)
                    dtDatosCompany = reporteBL.Obtener_Datos_Empresa()
                    If dtImprimir.Rows.Count() <> 0 Then
                        crystalBL.Muestra_Reporte("rpt_Arqueo_Caja_Detallado.rpt", dtImprimir, "", "",
                                                  "@FECHA;" & dtp_fecha_cierre_ventas.Value.ToString("dd/MM/yyyy"),
                                                  "@USUARIO;" & LibComunVar.ClsVarComun.USUARIO,
                                                  "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString,
                                                  "RUC;" & dtDatosCompany.Rows(0).Item("VAT_REGISTRATION").ToString)
    ...
    Private Sub btn_crear_planilla_Click(sender As Object, e As EventArgs) Handles btn_crear_planilla.Click
        Try
            ...
            dtTipoCamb_tc = Nothing
            dtTipoCamb_tc = cl.Verifircar_Planilla_Caja_chica_2(dtp_fec_nueva_pla.Value.ToString("dd/MM/yyyy"), LibComunVar.ClsVarComun.USUARIO)
            If dtTipoCamb_tc.Rows.Count() > 0 Then
                Me.Cursor = Cursors.Default
                ...
                Case Keys.Enter
                    ...
                    If InStr(txt_buscador_productos.Text, "*") > 0 Then
                        ...
                        If dt_lista_productos.Rows.Count() <> 0 Then
                            ...
                            dgv_lista_productos.Columns("FACTOR").Visible = False
                            dgv_lista_productos.Columns("ES_ANILLO").Visible = False
    ...
    Private Sub AMOUNT_AMERICAN_EXPRES_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_plin.KeyDown
        If e.KeyCode = Keys.Enter Then
            txt_cobro_venta_anterior.Focus()
        End If
    End Sub
    ...
    Private Sub btn_grabar_nuevo_cliente_Click(sender As Object, e As EventArgs) Handles btn_grabar_nuevo_cliente.Click
        Try
            ...
            CONSULTA = "INSERT INTO dbo.CUSTOMER (ID, NAME, ADDR, PHONE, VAT_REGISTRATION, NUMBER_DOC, DISCOUNT_PERCENT, TERMS_TYPE, STATUS, OPEN_DATE, CONTACT, STATE_ID, CREATE_USER, CREATE_DATE, MODIFY_DATE, TYPE_PRICE, SALES_ID, SELL_ZONE, COUNTRY, " _
                    ...
                    & " VALUES ('" & txt_cod_cliente.Text & "', '" & txt_razon_social.Text & "', '" & txt_direccion.Text & "', '" & txt_Celular.Text & "', '" & txt_ruc_dni.Text & "', '', 0, '00', 'V', GETDATE(), '', '" & txt_cod_distrito.Text & "', '" & LibComunVar.ClsVarComun.USUARIO & "', " _
                    & " GETDATE(), GETDATE(), '', '00', '', '', '" & txt_cod_departamento.Text & "', '" & txt_cod_provincia.Text & "', '', '', 0, 0, 0, 0, '', 0, 0, 0, 0, '', '', '', '',  " _
    ...
    Private Sub btn_cierre_ventas_Click_1(sender As Object, e As EventArgs) Handles btn_cierre_ventas.Click
        Dim cl As LibCobranzas.ClsOperaciones.CURRENCY_EXCHANGE
        cl = New LibCobranzas.ClsOperaciones.CURRENCY_EXCHANGE
        Dim dtTipoCamb_tc As DataTable
        dtTipoCamb_tc = New DataTable
        ...
        Else
            ...
            txt_cobro_venta_anterior.Text = "0"
    ...
    Private Sub txtprecioTotal_KeyDown(sender As Object, e As KeyEventArgs) Handles txtprecioTotal.KeyDown
        If e.KeyCode = Keys.Enter Then
            If txtprecioTotal.Text <> "" And txtcantidad.Text <> "" Then
                txtprecioUnitario.Text = CDbl(txtprecioTotal.Text) / CDbl(txtcantidad.Text)
                txtprecioUnitario.Text = Format(Double.Parse(txtprecioUnitario.Text), "##,##0.000000")
            End If
            txtprecioUnitario.Focus()
        End If
    End Sub

    Private Sub btn_cal_cantidad_Click(sender As Object, e As EventArgs) Handles btn_cal_cantidad.Click
        Dim f As New FrmfacturacionTienda_Cantidad
        f.factor = _factor
        f.ShowDialog()
        If f.fl_close = False Then
            txtcantidad.Text = f.cantidad
            txtcantidad_equivalente.Text = f.cantidad_equivalente
            _tamaño = f.tamaño
            _nueva_cantidad = f.nueva_cantidad
            txtcantidad.Select()
        End If
    End Sub
    ...
    Private Sub btn_rep_arqueo_caja_Click(sender As Object, e As EventArgs) Handles btn_rep_arqueo_caja.Click
        ToolStrip1.Enabled = False
        pnlPrincipal.Enabled = False
        Panel1.Visible = True
        dtp_rep_ini.Value = ClsVarComun.FechaSistema
        dtp_rep_fin.Value = ModFunciones.Ultimo_Dia_Mes(ClsVarComun.FechaSistema)
        txt_cod_personal.Text = ""
        txt_des_personal.Text = ""
        If NIVEL_ACCESO() Then
            txt_cod_personal.Enabled = True
            txt_cod_personal.Focus()
        Else
            txt_cod_personal.Enabled = False
            txt_cod_personal.Text = LibComunVar.ClsVarComun.USUARIO
            txt_des_personal.Text = "" 'LibComunVar.ClsVarComun.NOMBRE_USUARIO
            Button4.Focus()
        End If
    End Sub
    ...
    Private Sub txt_cod_personal_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_personal.MouseDoubleClick
        Ayuda_Vendedor("PERSONAL", txt_cod_personal, txt_des_personal)
    End Sub
    ...
    Private Sub txt_cod_personal_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_personal.KeyDown
        ...
        End If
    End Sub
    Private Sub Ayuda_Vendedor(ByVal _CODIGO As String, ByVal CODIGO_TEXTO As TextBox, ByVal DESC_TEXTO As TextBox)
        Try
            Dim frm As New frmBuscar
            Dim sql As String = String.Empty
            If _CODIGO = "CONCEPTOS" Then
                sql = "CCAJA_CHICA_SP_S_CONCEPTOS"
                frm.Titulo = "LISTA DE CONCEPTOS"
            ElseIf _CODIGO = "PERSONAL" Then
                sql = "CCAJA_CHICA_SP_S_USUARIOS"
                frm.Titulo = "LISTA DE USUARIOS"
            End If
            frm.CadenaConsulta = sql
            frm.ShowDialog()
            If frm.Data_Matriz.Rows.Count > 0 Then
                CODIGO_TEXTO.Text = frm.Data_Matriz.Rows(0).Item(0)
                DESC_TEXTO.Text = frm.Data_Matriz.Rows(0).Item(1).ToString
            End If
            frm.Close()
        Catch ex As Exception
            MsgBox(ex.Message)
    ...
    Private Sub Button4_Click_1(sender As Object, e As EventArgs) Handles Button4.Click
        Imprimir_Planillas_Varios(dtp_rep_ini.Value.ToString("dd/MM/yyyy"), dtp_rep_fin.Value.ToString("dd/MM/yyyy"), txt_cod_concepto.Text, txt_cod_personal.Text, "")
    End Sub
    Private Sub Imprimir_Planillas_Varios(ByVal _fecha_inicio As String, ByVal _fecha_fin As String, cod_concepto_ As String, cod_personal_ As String, cod_rendicion_ As String)
        Try
            ...
            If rb_resumido.Checked Then

                dtImprimir = reporteBL.Reporte_Cierre_Ventas(_fecha_inicio, cod_personal_)
                dtDatosCompany = reporteBL.Obtener_Datos_Empresa()
                If dtImprimir.Rows.Count() <> 0 Then
                    crystalBL.Muestra_Reporte("rpt_Arqueo_Caja.rpt", dtImprimir, "", "",
                                              "@FECHA;" & _fecha_inicio,
                                              "@USUARIO;" & cod_personal_,
                                              "EMPRESA;" & dtDatosCompany.Rows(0).Item("REPORT_SCREEN").ToString,
                                              "RUC;" & dtDatosCompany.Rows(0).Item("VAT_REGISTRATION").ToString)
                ...
                Else
                    MsgBox("No hay informacion disponible para mostrar.", MsgBoxStyle.Information)
                End If
            ElseIf rb_detallado.Checked Then
                

                dtImprimir = reporteBL.Reporte_Cierre_Ventas_Detallado(_fecha_inicio, cod_personal_)
                dtDatosCompany = reporteBL.Obtener_Datos_Empresa()
                If dtImprimir.Rows.Count() <> 0 Then
                    crystalBL.Muestra_Reporte("rpt_Arqueo_Caja_Detallado.rpt", dtImprimir, "", "",
                                              "@FECHA;" & _fecha_inicio,
            ...
            If Strings.Left(Ref_NUMBER_SERIE, 1) = "F" Or Strings.Left(Ref_NUMBER_SERIE, 1) = "B" Then
                ...
                Else
                    ...
                    Else
                        ...
                        If MessageBox.Show("¿Desea enviar el conprobante elegido?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                            '**************
    ...
    Private Sub dgvDocumentosFactura_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvDocumentosFactura.CellContentClick
        If dgvDocumentosFactura.CurrentRow Is Nothing Then Exit Sub
        Dim STREstado As String = String.Empty
        STREstado = dgvDocumentosFactura.CurrentRow.Cells("Estado").Value

        If dgvDocumentosFactura.CurrentRow.Cells("IS_CLOSED").Value = False Then btn_Apertura_Doc.Visible = False : Exit Sub
        ...
        If Strings.Left(dgvDocumentosFactura.CurrentRow.Cells("NUMBER_SERIE").Value, 1) = "B" Or Strings.Left(dgvDocumentosFactura.CurrentRow.Cells("NUMBER_SERIE").Value, 1) = "F" Then
            If CInt(dgvDocumentosFactura.CurrentRow.Cells("DIAS").Value) > 3 Then
                btn_Apertura_Doc.Visible = False
                Exit Sub
            End If
            If STREstado <> "ANULADO" Then
                If NIVEL_ACCESO() Then
                    btn_Apertura_Doc.Visible = True
                End If
            Else
                btn_Apertura_Doc.Visible = False
            End If
    ...
    Private Sub btn_Apertura_Doc_Click(sender As Object, e As EventArgs) Handles btn_Apertura_Doc.Click
        If dgvDocumentosFactura.CurrentRow Is Nothing Then Exit Sub
        Dim STREstado As String = String.Empty
        STREstado = dgvDocumentosFactura.CurrentRow.Cells("Estado").Value
        If STREstado = "ANULADO" Then
        ...
        If dgvDocumentosFactura.CurrentRow.Cells("IS_CLOSED").Value = True Then
            If ValidacionConsultas(Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT, ref_fecha_doc) = False Then Exit Sub
    ...
    Private Sub btn_facturar_pedido_Click(sender As Object, e As EventArgs) Handles btn_facturar_pedido.Click
        Mostrando_Pedidos_Cliente()
    End Sub

    Private Sub Mostrando_Pedidos_Cliente()
        Try
            Me.Cursor = Cursors.WaitCursor
            clsFacturaBl = New ClsNegocio.RECEIVABLE
            dtDetalleFact = New DataTable("DocumentoCliente")
            dtv_pedidos = New DataView
            dtDetalleFact = clsFacturaBl.Get_ClienteDocumento_Pedidos(txtCodCliente.Text, txtAlmacen.Text)
            dtv_pedidos = dtDetalleFact.DefaultView
            If dtDetalleFact.Rows.Count() <> 0 Then
                pnlDocumentosGuiaVenta.Visible = True
                GbCabecera.Enabled = False
                dgvDocumentosCliente.DataSource = dtv_pedidos
                dgvDocumentosCliente.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells
                STRordenCliente_pedidos = dgvDocumentosCliente.Columns(2).Name
                ...
                txtFiltroCliente.Text = String.Empty
            Else
                MsgBox("El Cliente no posee ningun Pedido.", MsgBoxStyle.Information, "Sistemas")
                pnlDocumentosGuiaVenta.Visible = False
                GenerarColummnaDataTable()
    ...
    Private Sub txtFiltroCliente_TextChanged(sender As Object, e As EventArgs) Handles txtFiltroCliente.TextChanged
        Dim wbusqueda As String = UCase(txtFiltroCliente.Text)
        Dim myCurrencyManager As CurrencyManager
        myCurrencyManager = CType(Me.BindingContext(dtv_pedidos), CurrencyManager)
        Dim INTnewpos As Integer
        dtv_pedidos.RowFilter = STRordenCliente_pedidos & " like '%" & txtFiltroCliente.Text & "%'"
        myCurrencyManager.Position = INTnewpos
    End Sub
    ...
    Private Sub btn_ok_Click(sender As Object, e As EventArgs) Handles btn_ok.Click
        Try
            ...
            If ListaDocCliente.Count() <> 0 Then
                ...
                clsFacturaBl = New ClsNegocio.RECEIVABLE
                GenerarColummnaDataTable()
                dtdetalleArticuloPrincipal = clsFacturaBl.Get_ClienteDetallesDocumento_Pedidos(NumerosDocClientes)
                If dtdetalleArticuloPrincipal.Rows.Count() <> 0 Then
                    dgvDetalle.DataSource = dtdetalleArticuloPrincipal
                    Factura_Pedido = True
                Else
                ...
                Calcular_Totales()
            Else
                MsgBox("Debe seleccionar al menos un Pedido.", MsgBoxStyle.Information)
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub txt_tipo_doc_ref_MouseDoubleClick_1(sender As Object, e As MouseEventArgs) Handles txt_tipo_doc_ref.MouseDoubleClick
        Ayuda_Doc_Referencia()
    End Sub

    Private Sub txt_tipo_doc_ref_KeyDown_1(sender As Object, e As KeyEventArgs) Handles txt_tipo_doc_ref.KeyDown
        If e.KeyCode = Keys.F1 Then Ayuda_Doc_Referencia()
        If e.KeyCode = Keys.Enter Then
            If txt_tipo_doc_ref.Text = String.Empty Then
                Ayuda_Doc_Referencia()
    ...
    Private Sub chk_venta_cortesia_CheckedChanged(sender As Object, e As EventArgs) Handles chk_venta_cortesia.CheckedChanged
        If chk_venta_cortesia.Checked Then
            chk_venta_sin_Descargo.Checked = False
        End If
    End Sub

    Private Sub chk_venta_sin_Descargo_CheckedChanged(sender As Object, e As EventArgs) Handles chk_venta_sin_Descargo.CheckedChanged
        If chk_venta_sin_Descargo.Checked Then
            chk_venta_cortesia.Checked = False
        End If
    End Sub

    Private Sub ActualizarCantidadEnComprobanteToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ActualizarCantidadEnComprobanteToolStripMenuItem.Click
        If dgvDocumentosFactura.CurrentRow Is Nothing Then Exit Sub
        ...
        Try
            ...
            If MessageBox.Show("¿Desea actualizar la cantidad del Documento: " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " ?", "Aviso", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                If Actualizar_Cantidad_Comprobante(Ref_DOCUMENT_ID, Ref_NUMBER_SERIE, Ref_NUMBER_DOCUMENT) = False Then
                    MsgBox("Hubo un error, no se completo el Proceso de actualizar la cantidad del documento elegido.", MsgBoxStyle.Exclamation)
                    Me.Cursor = Cursors.Default
                    Exit Sub
                Else
                    DocumentosFactura()
                    Dim msj As String
                    msj = String.Empty
                    msj = "Cantidad actualizada del documento " & Ref_DOCUMENT_ID & " -  " & Ref_NUMBER_SERIE & Ref_NUMBER_DOCUMENT & " generado correctamente."
                    MsgBox(msj, MsgBoxStyle.Information)
                End If
            End If
            Me.Cursor = Cursors.Default
    ...
    Private Sub txt_cobro_venta_anterior_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_cobro_venta_anterior.KeyPress
        If Char.IsDigit(e.KeyChar) Or e.KeyChar = "." Then
            e.Handled = False
        ElseIf Char.IsControl(e.KeyChar) Then
            e.Handled = False
    ...
    Private Sub txt_cobro_venta_anterior_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cobro_venta_anterior.KeyDown
        If e.KeyCode = Keys.Enter Then
            Button12.Focus()
        End If
    End Sub
