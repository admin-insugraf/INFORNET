...
Public Class FrmBuscar_Anticipos
    ...
    Private Sub FrmBuscar_Anticipos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub MostrarBusqueda()
        Try
            ...
            If dtData.Rows.Count() <> 0 Then
                ...
                dgvdato.Columns(0).Width = 150
                dgvdato.Columns(1).Width = 300

                If dtData.Columns.Count > 3 And dtData.Rows(0).Item(0).ToString = "AN" Then
                    dgvdato.Columns(6).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                    dgvdato.Columns(5).DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter
                    dgvdato.Columns(6).DefaultCellStyle.Format = "##,##0.00"
