...
Public Class frm_GuiaRemision_tranferencia_Interna
    ...
    Private Function GenerarIngresoAlmacen() As Boolean
        Try
            ...
            If almacenBL.GuardarAlmacen_II(alm_cabBE, ls_det_alm, "I", _TIPODOC_NS, _NUMERO_NS, _ALMACEN_NS) Then
                Dim msj As String = String.Empty
    ...
    Private Sub imprimirGuiaRemision(ByVal idalamacen As String, ByVal documentid As String, ByVal numerodocument As String)
        Try
            ...
            If dtImprimir.Rows.Count() <> 0 Then
                ...
                If dtImprimir.Rows(0).Item("TRANS_ID1").ToString = "TD" Then
    ...
    Private Function Verificar_Apertura_Cierre_Modulos(ByVal Mes As String, ByVal anyo As String) As Boolean
        ...
        Try
            ...
            If dtCierre.Rows.Count() > 0 Then
                MsgBox("El mes seleccionado se encuentra CERRADO," & Chr(13) & "APERTURAR para generar la Transferencia.", MsgBoxStyle.Critical)
                Estado = False
                Exit Try
            End If
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        ...
        If GenerarSalidaAlmacen() Then
            'Generando el Ingreso al Almacen de Destino
    ...
    Private Sub DocumentosGuiaRemision()
        Try
            ...
            dtDocumentoGuias = clsGuiaRemisionBl.get_DatosGeneralesGuiaTransferencia(dtpfechaInicial.Value.ToString("dd/MM/yyyy"), dtpfechafinal.Value.ToString("dd/MM/yyyy"), _
        ...
        If txtTipoDocRef.Text = "PE" Then
            Try
                ...
                If frm.Data_Matriz.Rows.Count > 0 Then
                    ...
                    dtdetalleArticuloPrincipal = clsAlmacenDetBl.get_Parte_Entrega_Traslado_PT(CInt(txtNumDocRef.Text))
        ...
        If txtTipoDocRef.Text = "OP" Then
            Try
                ...
                If frm.Data_Matriz.Rows.Count > 0 Then
                    ...
                    dtdetalleArticuloPrincipal = clsAlmacenDetBl.get_Orden_Produccion_Traslado_PT(CInt(txtNumDocRef.Text), _ITEM)
