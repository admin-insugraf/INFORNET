...
Public Class frm_CX_MA_Banco_Cuenta_Pago
    ...
    Private Sub Cargar_Data()
        Dim bancoBL As New ClsOperaciones.ACCOUNT_BANK_PAY
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        Dim cuentaBL As New ClsOperaciones.ACCOUNT_BANK_PAY
        Dim cuentaBE As New ClsEntidades.ACCOUNT_BANK_PAY
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            Dim bancoBL As New ClsOperaciones.ACCOUNT_BANK_PAY
            Dim bancoBE As New ClsEntidades.ACCOUNT_BANK_PAY
