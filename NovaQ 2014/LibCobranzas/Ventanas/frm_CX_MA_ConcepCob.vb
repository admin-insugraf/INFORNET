...
Public Class frm_CX_MA_ConcepCob
    ...
    Private Sub Cargar_Datos()
        ...
        dgv_lista.DataSource = conceptosBL.get_Conceptos
        conceptosBL = Nothing
    End Sub
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        Dim conceptosBL As New ClsOperaciones.TYPE_RECEIVE
        Dim conceptosBE As New ClsEntidades.TYPE_RECEIVE
        With conceptosBE
            .TYPE = ""
        ...
        If bol_nuevo Then
            conceptosBL.Insert(conceptosBE)
        Else
            conceptosBL.Update(conceptosBE)
        End If
        conceptosBL = Nothing
        conceptosBE = Nothing
        Avisar("Listo!")
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            ...
            conceptosBL.Delete(conceptosBE)
            conceptosBE = Nothing
            conceptosBL = Nothing
            Call Cargar_Datos()
            Call Avisar("Listo!")
