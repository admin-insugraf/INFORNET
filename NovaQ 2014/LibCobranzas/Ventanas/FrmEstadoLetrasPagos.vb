...
Public Class FrmEstadoLetrasPagos
    Dim bol_nuevo As Boolean = False
    Private Sub FrmEstadoLetrasPagos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Datos()
        ...
        dgv_lista.DataSource = conceptosBL.get_Situacion_Letras_Pagos
    ...
    Private Sub btn_Nuevo_Click(sender As Object, e As EventArgs) Handles btn_Nuevo.Click
        ...
        chk_genera_asiento.Checked = False
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        ...
        If bol_nuevo Then
            dt_validador = conceptosBL.get_Valida_Cod_Situacion_Letter_Pay(txt_cod.Text, cmb_moneda.SelectedValue)
        ...
        If bol_nuevo Then
            conceptosBL.Insert_Status_Letter_Pay(conceptosBE)
        Else
            conceptosBL.Update_Status_Letter_Pay(conceptosBE)
        End If
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            ...
            conceptosBL.Delete_Situacion_Letras_Pay(conceptosBE)
            conceptosBE = Nothing
            conceptosBL = Nothing
            Call Cargar_Datos()
