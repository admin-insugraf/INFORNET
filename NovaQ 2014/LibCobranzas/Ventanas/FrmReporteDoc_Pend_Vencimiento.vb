...
Public Class FrmReporteDoc_Pend_Vencimiento
    ...
    Private Sub ImprimirDocumentosPorVencimiento()
        Try
            ...
            If dtImprimir.Rows.Count() <> 0 Then
                ...
                crystalBL.Muestra_Reporte("rpt_Doc_Pend_Clientes_Vencidos.rpt", "", "", "", "@FECHA_INICIAL;" & dtpfechaInicio.Value.ToString("dd/MM/yyyy"), "@FECHA_FINAL;" & dtpfechaFin.Value.ToString("dd/MM/yyyy"), "@CLIENTE_INICIAL;" & txtclienteInicial.Text, "@CLIENTE_FINAL;" & txtclienteFinal.Text, "@VENDEDOR_INICIAL;" & txtVendedorInicial.Text, "@VENDEDOR_FINAL;" & txtVendedorFinal.Text, "@CLI_INI;" & clienteInicial, "@CLI_FIN;" & clientefinal, "@VEN_INI;" & VendedorInicial, "@VEN_FIN;" & VendedorFinal)
            Else
