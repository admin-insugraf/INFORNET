...
Public Class Frm_OP_Planta_Parte_Produccion
    ...
    Private Sub Button36_Click(sender As Object, e As EventArgs) Handles Button36.Click
        Try
            ...
            Else
                ...
                dt_detalle_produccion_programada2 = clsPedidoBl.get_Parte_Produccion_Produccion_Programada2_Orden_Desarrollo(TextBox6.Text.Trim, _
                                                                                                      fecha_2.ToString("dd/MM/yyyy"), _
                                                                                                      fecha_2.ToString("dd/MM/yyyy"), _
    ...
    Private Sub Formato_Grillas(ByVal dt_puente As DataView, ByVal dg_puente As DataGridView)
        If dt_puente.Count() <> 0 Then
            ...
            If _tipo_maquina = "1" Then 'TextBox6.Text.Trim = "15" Or TextBox6.Text.Trim = "37" Then 'guillotina polar
                ...
                dg_puente.Columns("Hora").Visible = False 'Width = 50
                ...
                dg_puente.Columns("ObservacionesProducción").Visible = False
                ...
                dg_puente.Columns("Elemento").Visible = False 'HeaderText = "Und"
    ...
    Private Function Guardar_Parte_Produccion(ByVal _ESTADO As String) As Boolean
        ...
        Try
            ...
            If clsPedidoBl.Guardar_Parte_Produccion_Detalle_Orden_Desarrollo(Mantenimiento_Parte_produccion, TextBox6.Text.Trim) = False Then
    ...
    Private Sub Detalle_Op(ByVal opcion_ As String, ByVal id_ As Integer, ByVal item_ As Integer)
        Try
            ...
            dt_detalle = clsPedidoBl.get_Parte_Produccion_Detalle_Orden_Desarrollo(opcion_, id_, item_)
    ...
    Private Sub Detalle_Actividad_Op(ByVal opcion_ As String, ByVal id_ As Integer, ByVal item_ As Integer)
        Try
            ...
            dtdetalle = clsPedidoBl.get_Parte_Produccion_Detalle_Movimientos_Orden_Desarrollo(opcion_, id_, item_)
            dgv_detalle_historial.DataSource = Nothing
            If dtdetalle.Rows.Count() > 0 Then
                dgv_detalle_historial.DataSource = dtdetalle
    ...
    Private Function Agregar_HP_Iniciar_Terminar_Turno(ByVal _OPCION_TURNO As String, ByVal _TURNO As String, Optional ByVal _AYUDANTE As String = "",
        ...
        Try
            ...
            If clsPedidoBl.Guardar_Parte_Produccion_Historial_Personal_Sin_Trabajo(Pedido_Det_HP) = False Then
                MsgBox("Registro de Turno no se registro.", MsgBoxStyle.Exclamation, "Sistemas")
                Me.Cursor = Cursors.Default
                Return False
            Else
                Me.Cursor = Cursors.Default
    ...
    Private Sub dgv_produccion_programada2_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles dgv_produccion_programada2.CellMouseDoubleClick
        ...
        Try
            ...
            TextBox3.Text = "PARTE PRODUCCION " & Strings.UCase(TextBox5.Text.Trim) & "- ORDEN DE DESARROLLO N° " & dgv_produccion_programada2.CurrentRow.Cells("Num.O.P.").Value
