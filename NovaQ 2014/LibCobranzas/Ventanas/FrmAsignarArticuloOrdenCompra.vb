...
Public Class FrmAsignarArticuloOrdenCompra
    ...
    Private Sub MostrandoArticulos(ByVal TipoMovimiento As String)
        Try
            ...
            If frm.Data_Matriz.Rows.Count > 0 Then
                ...
                Stock = frm.Data_Matriz.Rows(0).Item(4).ToString
        ...
        Try
            ...
            If TipoMov = "S" Then
                If CDbl(txtStockLote.Text) < txtcantidad.Text Then
                    ...
                    txtcantidad.Select()
                    Exit Try
                ElseIf CDbl(txtsaldo.Text) < txtcantidad.Text Then
    ...
    Private Sub AjustarTamaño(ByVal opcion As Boolean)
        If opcion = True Then
            Size = New System.Drawing.Size(951, 295)
            Me.GroupBox2.Enabled = False
        Else
            Size = New System.Drawing.Size(588, 295)
