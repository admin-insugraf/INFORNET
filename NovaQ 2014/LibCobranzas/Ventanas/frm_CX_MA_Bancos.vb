...
Public Class frm_CX_MA_Bancos
    ...
    Private Sub Ayuda_Conceptos()
        Try
            ...
            sql = "CX_SP_S_CONCEPTOS"
            frm.CadenaConsulta = sql
            frm.Titulo = "Tipo de Cobranza"
            frm.ShowDialog()
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        If Preguntar("Seguro de eliminar?") Then
            Dim bancoBL As New ClsOperaciones.BANK
            Dim bancoBE As New ClsEntidades.BANK
            bancoBE.ID = dgv_bancos.CurrentRow.Cells("col_id").Value.ToString
            bancoBL.Delete(bancoBE)
            bancoBE = Nothing
            bancoBL = Nothing
            Call Avisar("Transaccion generada correctamente!")
            Call Cargar_Data()
        End If
    ...
    Private Sub btn_cta_cte_Click(sender As Object, e As EventArgs) Handles btn_cta_cte.Click
        ...
        Dim f As New frm_CX_MA_Banco_Cuenta
