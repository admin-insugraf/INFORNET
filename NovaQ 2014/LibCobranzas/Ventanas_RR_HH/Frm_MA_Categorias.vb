...
Public Class Frm_MA_Categorias
    Dim AreaBl As ClsOperaciones.Personal_RRHH
    Dim Flag_modo_edicion As Boolean = False
    Private Sub Frm_MA_Categorias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Function Numeracion() As String
        ...
        Try
            ...
            CORRELATIVOBL.NumeroCorrelativo_Categorias()
            If String.IsNullOrEmpty(CORRELATIVOBL.Correlativo_Categorias.ToString) Then
                Correlativo = "00"
            Else
                Correlativo = String.Format("{0:00}", CInt(CORRELATIVOBL.Correlativo_Categorias + 1))
            End If
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        If txtcodigo.Text = String.Empty Then
            MsgBox("Debe ingresar el Codigo de la Categoria.", MsgBoxStyle.Exclamation)
            txtcodigo.Focus()
            Exit Sub
        ElseIf txtdescripcion.Text = String.Empty Then
            MsgBox("Debe ingresar una descripción de la Categoria.", MsgBoxStyle.Exclamation)
            txtdescripcion.Focus()
            Exit Sub
        ElseIf txt_jornada_trabajo.Text = String.Empty Then
            MsgBox("Debe ingresar la Jornada de Trabajo", MsgBoxStyle.Exclamation)
            txt_jornada_trabajo.Focus()
            Exit Sub
        ElseIf CDbl(txt_jornada_trabajo.Text) = 0 Then
            MsgBox("La Jornada de Trabajo no puede ser cero.", MsgBoxStyle.Exclamation)
            txt_jornada_trabajo.Focus()
            Exit Sub
        End If
        ...
        Try
            ...
            areaEnt.JORNADA_TRABAJO = CDbl(txt_jornada_trabajo.Text)

            If Flag_modo_edicion = False Then
                If AreaBl.Guardar_Categorias(areaEnt) = True Then
                    MsgBox("Agregado correctamente.", MsgBoxStyle.Information)
                Else
                    MsgBox("Hubo un error.", MsgBoxStyle.Exclamation)
                End If
            Else
                If AreaBl.Actualizar_Categoria(areaEnt) = True Then
    ...
    Private Sub btn_Editar_Click(sender As Object, e As EventArgs) Handles btn_Editar.Click
        ...
        txt_jornada_trabajo.Text = dgvCabecera.Item(2, dgvCabecera.CurrentRow.Index).Value
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        Try
            ...
            If MessageBox.Show("Seguro de Eliminar?", "Cuidado!", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = System.Windows.Forms.DialogResult.Yes Then
                ...
                Codigo = dgvCabecera.Item(0, dgvCabecera.CurrentRow.Index).Value
                If String.IsNullOrEmpty(Codigo) Then Exit Sub
                If AreaBl.Eliminacion_Categorias(Codigo) = True Then
    ...
    Private Sub DocumentosPrincipal()
        Try
            ...
            dtCabecera = AreaBl.DocumentoPrincipal_Categorias()
            If dtCabecera.Rows.Count() <> 0 Then
                ...
                dgvCabecera.Columns(2).Width = 200
                dgvCabecera.Columns(2).HeaderText = "Jornada de Trabajo"
    ...
    Private Sub txt_jornada_trabajo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_jornada_trabajo.KeyPress
