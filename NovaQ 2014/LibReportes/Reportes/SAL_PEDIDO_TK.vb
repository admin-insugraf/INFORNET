...
Public Class SAL_PEDIDO_TK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LibReportes.SAL_PEDIDO_TK.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_letras() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedSAL_PEDIDO_TK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SAL_PEDIDO_TK = New SAL_PEDIDO_TK()
        rpt.Site = Me.Site
        Return rpt
    End Function
