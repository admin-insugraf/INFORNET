Public Class ClsOrdenCompraTO

    Public Class Cab_Ordenes_TO
        Private _STRNumOrden As String
        Private _DTFechaOrden As Date
        ...
        Public Sub New()
            _STRNumOrden = String.Empty
            _DTFechaOrden = Date.Now
