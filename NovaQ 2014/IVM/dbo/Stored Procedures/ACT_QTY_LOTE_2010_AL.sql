CREATE PROCEDURE  ACT_QTY_LOTE_2010_AL
@ALMACEN VARCHAR(10)    
AS   
--=====================================================================  
...
INNER JOIN  PART P    
ON P.ID=WL.PART_ID   
WHERE WT.TYPE_TRANS='I' AND P.IS_LOT='S'  AND WT.WAREHOUSE_ID=@ALMACEN AND  WT.TRANS_ID<>'GF' AND WT.STATUS_GUIA<>'A'  
...
INNER JOIN  PART P    
ON P.ID=WL.PART_ID   
WHERE WT.TYPE_TRANS='S' AND P.IS_LOT='S' AND WT.WAREHOUSE_ID=@ALMACEN AND  WT.TRANS_ID<>'GF' AND WT.STATUS_GUIA<>'A'  
GROUP BY WT.WAREHOUSE_ID , P.ID ,WL.NUMBER_LOT   
ORDER BY WL.NUMBER_LOT     
--=====================================================================     
