...
Public Class Frm_OP_PLanta_Bandeja_Despachos_Alamax
    ...
    Private Sub Frm_OP_PLanta_Bandeja_Despachos_Alamax_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub GenerarColummnaDataTable_Incripciones_RS()
        ...
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("CODIGO_MAQUINA", Type.GetType("System.String"))
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("MAQUINA", Type.GetType("System.String"))
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("FECHA", Type.GetType("System.String"))
        ...
        dgv_incripciones_regsanit.Columns(1).Visible = False
        dgv_incripciones_regsanit.Columns(2).HeaderText = "Maquina"
        dgv_incripciones_regsanit.Columns(3).HeaderText = "Fecha"
            ...
            If MsgBox("Esta seguro de registrar la Programación de O.P.?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                ...
                For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                    If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                        ...
                        For j As Integer = 0 To dtdetalleArticuloPrincipal_Incripciones_RegSanit.Rows.Count() - 1
                            PedidoCabENT = New ClsEntidades.MANTENIMIENTO_OP
                            With PedidoCabENT
                                .ID = dgv_detalle_prog_despacho.Rows(i).Cells("CODIGO_INTERNO").Value
                                .ESTADO_DESPACHO = "SI"
                                .FECHA_DESPACHO = dtdetalleArticuloPrincipal_Incripciones_RegSanit.Rows(j).Item("FECHA").ToString 'dtp_fecha_despacho.Value.ToString("dd/MM/yyyy")
                                ...
                                .COD_EQUIPO = dtdetalleArticuloPrincipal_Incripciones_RegSanit.Rows(j).Item("CODIGO_MAQUINA").ToString 'txt_cod_equipo.Text
                                'Vendedor
    ...
    Private Sub dgv_detalle_despachos_programados_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles dgv_detalle_despachos_programados.CellFormatting
        'If dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "OPERANDO" Then
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Blue
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.Blue
        'ElseIf dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "TERMINADO" Then
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Red
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.Red
        'ElseIf dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "PAUSADO" Then
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Orange
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.Orange
        'Else
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Black
        '    dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.Black
        'End If
    End Sub
    ...
    Private Sub btn_add_regsanit_Click(sender As Object, e As EventArgs) Handles btn_add_regsanit.Click
        Try
            ...
            row("CODIGO_MAQUINA") = txt_cod_equipo.Text.Trim
            row("MAQUINA") = txt_des_equipo.Text.Trim
            row("FECHA") = dtp_fecha_despacho.Value.ToString("dd/MM/yyyy")
            ...
            dtp_fecha_despacho.Value = LibComunVar.ClsVarComun.FechaSistema
            txt_des_equipo.Text = String.Empty
            txt_cod_equipo.Text = String.Empty
            txt_cod_equipo.Focus()
            dgv_incripciones_regsanit.DataSource = dtdetalleArticuloPrincipal_Incripciones_RegSanit
            'dgvDetalle.Refresh()
        Catch ex As Exception
    ...
    Function Validacion_Ingreso_Incripciones_Reg_Sanit() As Boolean
        ...
        If txt_cod_equipo.Text.Trim = "" Then
            MsgBox("Debe elegir un Equipo/Maquina", MsgBoxStyle.Exclamation, "Sistemas")
            Return False
            Exit Function
        End If
    ...
    Private Sub dtp_fecha_despacho_KeyDown(sender As Object, e As KeyEventArgs) Handles dtp_fecha_despacho.KeyDown
        If e.KeyCode = Keys.Enter Then
