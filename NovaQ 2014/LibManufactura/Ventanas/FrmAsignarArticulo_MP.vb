...
Public Class FrmAsignarArticulo_MP
    ...
    Private Sub FrmAsignarArticulo_MP_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Ayuda_Unidad_Medida()
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If Flag_Modo_Edicion = False Then
            ...
            row("DESCARGA_TOTAL") = row("QTY") * row("AVERAGE_COST") 'IIf(chkindicacion.Checked, 1, 0)
    ...
    Private Sub MostrandoArticulos()
        Try
            ...
            If frm.Data_Matriz.Rows.Count > 0 Then
                ...
                txtcosto.Text = Format(Stock, "##,##0.0000")
            End If
            frm.Close()
        Catch ex As Exception
            MsgBox(ex.Message)
