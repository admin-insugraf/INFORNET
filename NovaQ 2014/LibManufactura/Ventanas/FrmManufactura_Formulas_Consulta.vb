...
Public Class FrmManufactura_Formulas_Consulta
    ...
    Private Sub FrmManufactura_Formulas_Consulta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        dgvDetalle_Archivo2.DataSource = dtdetalleArchivos
        cargarImagen()
    End Sub
    ...
    Private Sub cargarImagen()
        If dgvDetalle_Archivo2.Rows.Count > 0 Then
            For Each Fila As DataGridViewRow In dgvDetalle_Archivo2.Rows
    ...
    Private Sub dgvDetalle_Archivo_CellContentClick(sender As Object, e As DataGridViewCellEventArgs)
    ...
    Private Sub cmAbrir_Click(sender As Object, e As EventArgs) Handles cmAbrir.Click
        Try
            ...
            Dim drArchivo As SqlClient.SqlDataReader
            Dim item_archivo As Integer = dgvDetalle_Archivo2.Item(2, dgvDetalle_Archivo2.CurrentRow.Index).Value
    ...
    Private Sub cmEliminar_Click(sender As Object, e As EventArgs)
        'Try
        '    If dgvDetalle_Archivo3.RowCount = 0 Then
        '        Exit Sub
        '    End If

        '    Dim item_archivo As Integer = dgvDetalle_Archivo3.Item(2, dgvDetalle_Archivo3.CurrentRow.Index).Value
        ...
        '        dtdetalleArchivos = reporteBL.get_Detalle_Archivos(txtcodigo.Text)
        '        dgvDetalle_Archivo3.DataSource = dtdetalleArchivos
        '        cargarImagen()
        '        reporteBL = Nothing
        '        Me.Cursor = Cursors.Default
    ...
    Private Sub dgvCabecera_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvCabecera.CellClick
        ...
        Try
            ...
            Alm = dgvCabecera.Item(2, dgvCabecera.CurrentRow.Index).Value
            txtcodigo.Text = _id
            GroupBox4.Text = "Ficha Tecnica/Hoja de seguridad de " & _id & "-" & Alm
