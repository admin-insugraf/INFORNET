...
Imports LibComunVar
Public Class FrmControl_Liberacion_Modificar_Prod_PT
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        Try
            If txtnumeroProtocolo.Text = "" Then
                MsgBox("Debe ingresar un Nro.Protocolo.", MsgBoxStyle.Critical)
                txtnumeroProtocolo.Select()
                Exit Sub
                'ElseIf txtnumanalisis.Text = "" Then
                '    MsgBox("Debe ingresar un Nro.Analisis.", MsgBoxStyle.Critical)
                '    txtnumanalisis.Select()
                '    Exit Sub
            End If
            ...
            row("VALORACION") = IIf(txtvaloracion.Text = String.Empty, "", txtvaloracion.Text)
    ...
    Private Sub txtnumeroProtocolo_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txtnumeroProtocolo.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Then txtcomentarios.Select()
    End Sub
