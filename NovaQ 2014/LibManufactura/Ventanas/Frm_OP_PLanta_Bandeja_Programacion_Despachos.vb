...
Public Class Frm_OP_PLanta_Bandeja_Programacion_Despachos
    ...
    Dim PedidoCabENT_ORDER_LINE_APP_DESPACHO As ClsEntidades.ORDER_LINE_APP_DESPACHO
    ...
    Public Sub GenerarColummnaDataTable_Detalle_Despacho()
        dtdetalleArticuloPrincipal_Incripciones_RegSanit = New DataTable
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("CODIGO_INTERNO", Type.GetType("System.Int64"))
        ...
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("CANTIDAD", Type.GetType("System.Double"))
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("PART_DESCRIPTION", Type.GetType("System.String"))
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("UNIT", Type.GetType("System.String"))
        dtdetalleArticuloPrincipal_Incripciones_RegSanit.Columns.Add("EMPRESA", Type.GetType("System.String"))
    End Sub

    Private Sub Frm_OP_PLanta_Bandeja_Programacion_Despachos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        txt_cod_trans.Text = ""
        txt_des_trans.Text = ""
        txt_cod_vehiculo.Text = ""
        txt_des_vehiculo.Text = ""
        _inicio = True
        chk_fusionar.Checked = False
        ...
        dtp_ff_dp.Value = ModFunciones.Ultimo_Dia_Mes(Date.Now.ToString("dd/MM/yyyy"))
    End Sub
    Private Sub Consulta_Despachos()
        Try
            ...
            dt_detalle_programa_despachos = clsPedidoBl.get_Programacion_Despachos(txt_cod_linea_produccion.Text)
            ...
            If dt_detalle_programa_despachos.Rows.Count() <> 0 Then
                ...
                dgv_detalle_prog_despacho.Columns("Observaciones").Width = 300 : dgv_detalle_prog_despacho.Columns("Observaciones").DisplayIndex = 20
                dgv_detalle_prog_despacho.Columns("EMPRESA").Visible = False

                dgv_detalle_prog_despacho.Columns("Responsable PICKING").Width = 300

            End If

            _contador_despachos = 0
            GenerarColummnaDataTable_Detalle_Despacho()
    ...
    Private Sub rdb_despacho_programado_CheckedChanged(sender As Object, e As EventArgs) Handles rdb_despacho_programado.CheckedChanged
        If rdb_despacho_programado.Checked Then
            Try
                ...
                chk_todos_trans.Checked = True
                chk_todos_vehiculo.Checked = True
                chk_todos_estado.Checked = True
    ...
    Private Sub btn_prog_despacho_final_Click(sender As Object, e As EventArgs) Handles btn_prog_despacho_final.Click
        ...
        Try
            If chk_fusionar.Checked Then
                Dim _codigo_uno, _codigo_dos As String
                ...
                For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                    If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                        If _contador = 0 Then
                            _codigo_uno = dgv_detalle_prog_despacho.Rows(i).Cells("Cliente").Value
                            _contador = _contador + 1
                        Else
                            If _codigo_uno <> dgv_detalle_prog_despacho.Rows(i).Cells("Cliente").Value Then
                                _flag = True
                                Exit For
                            End If
                        End If
                ...
                If _flag Then
                    MsgBox("Los Pedidos marcados son de distintos Clientes, no aplica la fusión.", MsgBoxStyle.Exclamation)
                    Exit Sub
                End If
            End If

            If MsgBox("Esta seguro de registrar la Programación de los Despachos?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                PedidoCabENT = New ClsEntidades.MANTENIMIENTO_OP
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                Dim MantenimientoOP_Lista_2 As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                Dim MantenimientoOP_Lista_ORDER_LINE_APP_DESPACHO As New List(Of ClsEntidades.ORDER_LINE_APP_DESPACHO)
                ...
                Dim _id_pedido_fusion As Integer = 0
                ...
                If chk_fusionar.Checked Then
                    For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                        If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                            ...
                            With PedidoCabENT
                                ...
                                _id_pedido_fusion = .ID
                                .ITEM_DESPACHO = dgv_detalle_prog_despacho.Rows(i).Cells("SecDespacho").Value
                                .EMPRESA = dgv_detalle_prog_despacho.Rows(i).Cells("EMPRESA").Value
                            End With
                    ...
                    For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                        If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                            ...
                            With PedidoCabENT
                                ...
                                .EMPRESA = dgv_detalle_prog_despacho.Rows(i).Cells("EMPRESA").Value
                            End With
                            MantenimientoOP_Lista_2.Add(PedidoCabENT)
                        End If
                    Next
                    ...
                    For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                        If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                            ...
                            For Each item As DataRow In dtdetalleArticuloPrincipal_Incripciones_RegSanit.Select("CODIGO_INTERNO=" & dgv_detalle_prog_despacho.Rows(i).Cells("CODIGO_INTERNO").Value)
                                _existe = True
                                Exit For
                            Next
                            ...
                            If _existe Then
                                For Each item As DataRow In dtdetalleArticuloPrincipal_Incripciones_RegSanit.Select("CODIGO_INTERNO=" & dgv_detalle_prog_despacho.Rows(i).Cells("CODIGO_INTERNO").Value)
                                    PedidoCabENT_ORDER_LINE_APP_DESPACHO = New ClsEntidades.ORDER_LINE_APP_DESPACHO
                                    With PedidoCabENT_ORDER_LINE_APP_DESPACHO
                                        .ID_CAB = _id_pedido_fusion 'item("CODIGO_INTERNO")
                                        .ITEM = item("ITEM")
                                        .PART_ID = item("CODIGO")
                                    ...
                                    End With
                                    MantenimientoOP_Lista_ORDER_LINE_APP_DESPACHO.Add(PedidoCabENT_ORDER_LINE_APP_DESPACHO)
                                Next
                            Else
                                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                                dtdetalleArticuloPrincipal = clsPedidoBl.Modo_Edicion_Detalle_Pedidos_Prog_Despacho(dgv_detalle_prog_despacho.Rows(i).Cells("NOP").Value)
                    ...
                    If clsPedidoBl.Guardar_Programacion_Despacho_OFicial_Fusionado(MantenimientoOP_Lista, MantenimientoOP_Lista_2, txt_cod_trans.Text, txt_des_vehiculo.Text,
                                                                         dtp_fecha_despacho.Value.ToString("dd/MM/yyyy"), txt_des_trans.Text,
                                                                         MantenimientoOP_Lista_ORDER_LINE_APP_DESPACHO) Then
                ...
                Else
                    ...
                    If clsPedidoBl.Guardar_Programacion_Despacho_OFicial(MantenimientoOP_Lista, txt_cod_trans.Text, txt_des_vehiculo.Text,
                                                                         dtp_fecha_despacho.Value.ToString("dd/MM/yyyy"), txt_des_trans.Text,
                                                                         MantenimientoOP_Lista_ORDER_LINE_APP_DESPACHO) Then
                        MsgBox("Programación de Despacho Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
    ...
    Private Sub dgv_detalle_despachos_programados_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles dgv_detalle_despachos_programados.CellFormatting
        If dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "Llegada a punto" Then
            dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Orange
            dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.White
        ElseIf dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "Despachado" Then
            dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.ForeColor = Color.Green
            dgv_detalle_despachos_programados.Rows(e.RowIndex).DefaultCellStyle.SelectionForeColor = Color.White
        ElseIf dgv_detalle_despachos_programados.Rows(e.RowIndex).Cells("ESTADO").Value = "No Despachado" Then
    ...
    Private Sub Button50_Click(sender As Object, e As EventArgs) Handles Button50.Click
        Try
            If chk_todos_trans.Checked = False And txt_cod_trans_consulta.Text = "" Then
                MsgBox("Debe elegir un Transportista", MsgBoxStyle.Exclamation)
                Exit Sub
            End If

            If chk_todos_vehiculo.Checked = False And txt_cod_vehiculo_consulta.Text = "" Then
                MsgBox("Debe elegir un Vehiculo", MsgBoxStyle.Exclamation)
                Exit Sub
            End If

            If chk_todos_estado.Checked = False And txt_cod_estado.Text = "" Then
                MsgBox("Debe elegir un Estado", MsgBoxStyle.Exclamation)
                Exit Sub
            End If
            ...
            dt_detalle_despachos_programados = clsPedidoBl.get_Lista_Programacion_Despachos(dtp_fi_dp.Value.ToString("dd/MM/yyyy"),
                                                                                                   dtp_ff_dp.Value.ToString("dd/MM/yyyy"),
                                                                                                   txt_cod_linea_produccion_2.Text,
                                                                                                   txt_cod_trans_consulta.Text,
                                                                                                   txt_cod_vehiculo_consulta.Text,
                                                                                                   txt_cod_estado.Text)
            dgv_detalle_despachos_programados.DataSource = Nothing
            gb_cambio_depachos_programados.Visible = False
            If dt_detalle_despachos_programados.Rows.Count() <> 0 Then
                ...
                dgv_detalle_despachos_programados.Columns(0).Width = 30
                dgv_detalle_despachos_programados.Columns(1).Width = 50
                dgv_detalle_despachos_programados.Columns(2).Width = 70
                dgv_detalle_despachos_programados.Columns(3).Width = 70
                dgv_detalle_despachos_programados.Columns(4).Visible = False
                dgv_detalle_despachos_programados.Columns(5).Visible = False
                dgv_detalle_despachos_programados.Columns(6).Width = 50
                dgv_detalle_despachos_programados.Columns(7).Width = 300
                dgv_detalle_despachos_programados.Columns(8).Width = 300
                dgv_detalle_despachos_programados.Columns(9).Width = 200
                dgv_detalle_despachos_programados.Columns(10).Width = 100
                dgv_detalle_despachos_programados.Columns(11).Width = 200
                dgv_detalle_despachos_programados.Columns(12).Width = 250

                dgv_detalle_despachos_programados.Columns("Producto").HeaderText = "Dirección de Entrega"
                dgv_detalle_despachos_programados.Columns("U.M.").HeaderText = "Transportista"
                dgv_detalle_despachos_programados.Columns("Cantidad").HeaderText = "Vehiculo"

                dgv_detalle_despachos_programados.Columns("Fecha/Hora llegada Punto").Width = 150
                dgv_detalle_despachos_programados.Columns("Fecha/Hora Despacho").Width = 150
                dgv_detalle_despachos_programados.Columns("Comentario Despacho").Width = 250
                dgv_detalle_despachos_programados.Columns("Estado").Width = 100
                dgv_detalle_despachos_programados.Columns("Motivo_No_Despacho").Width = 150
                dgv_detalle_despachos_programados.Columns("Cantidad_Entregada").Width = 120
                dgv_detalle_despachos_programados.Columns("UM_Entregada").Width = 120
                dgv_detalle_despachos_programados.Columns("Cantidad_Recogida").Width = 120
                dgv_detalle_despachos_programados.Columns("UM_Recogida").Width = 120

                dgv_detalle_despachos_programados.Columns("Motivo_No_Despacho").HeaderText = "Motivo No Despacho"
                dgv_detalle_despachos_programados.Columns("Cantidad_Entregada").HeaderText = "Cantidad Entregada"
                dgv_detalle_despachos_programados.Columns("UM_Entregada").HeaderText = "U.M. Entregada"
                dgv_detalle_despachos_programados.Columns("Cantidad_Recogida").HeaderText = "Cantidad Recogida"
                dgv_detalle_despachos_programados.Columns("UM_Recogida").HeaderText = "U.M. Recogida"
    ...
    Private Sub Button38_Click(sender As Object, e As EventArgs) Handles Button38.Click
        Try
            ...
            If dt_detalle_despachos_programados.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("rpt_Formato_Despacho_Programados.rpt", dt_detalle_despachos_programados, "", "", _
                                                  "@FECHA_INICIO;" & dtp_fi_dp.Value.ToString("dd/MM/yyyy"), _
                                                  "@FECHA_FIN;" & dtp_ff_dp.Value.ToString("dd/MM/yyyy"), _
                                                  "titulo;" & "PROGRAMACION DE O.P.", _
    ...
    Private Sub Button47_Click(sender As Object, e As EventArgs) Handles Button47.Click
        ...
        Try
            If MsgBox("Esta seguro de cambiar de Fecha a los Despachos Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Try
            If MsgBox("Esta seguro de extornar la Programación de Despachos elegida?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                ...
                For i As Integer = 0 To dgv_detalle_despachos_programados.Rows.Count - 1
                    If dgv_detalle_despachos_programados.Rows(i).Cells("SEL").Value Then
                        ...
                        With PedidoCabENT
                            ...
                            .ITEM_DESPACHO = dgv_detalle_despachos_programados.Rows(i).Cells("Sec. Despacho.").Value
                        End With
                        MantenimientoOP_Lista.Add(PedidoCabENT)
                    End If
                Next

                If clsPedidoBl.Guardar_Deshacer_Programacion_Despacho_Oficial(MantenimientoOP_Lista) Then
                    MsgBox("Extorno de Programación de Despacho Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
                    dgv_detalle_despachos_programados.DataSource = Nothing
                    dtp_fi_dp.Value = LibComunVar.ClsVarComun.FechaSistema
                    dtp_ff_dp.Value = ModFunciones.Ultimo_Dia_Mes(Date.Now)
                    Button50.Focus()
    ...
    Private Sub Button34_Click(sender As Object, e As EventArgs) Handles Button34.Click
        Try
            If MsgBox("Esta seguro de Actualizar la Fecha de los Despachos Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                ...
                If clsPedidoBl.Guardar_Act_Fecha_Programacion_Despacho_Oficial(MantenimientoOP_Lista) Then

                    MsgBox("Actualización de Programación de O.P. Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
                    dgv_detalle_despachos_programados.DataSource = Nothing
                    dtp_fi_dp.Value = LibComunVar.ClsVarComun.FechaSistema
                    dtp_ff_dp.Value = ModFunciones.Ultimo_Dia_Mes(Date.Now)
                    gb_cambio_depachos_programados.Visible = False
    ...
    Private Sub ProgramarDespManualToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ProgramarDespManualToolStripMenuItem.Click
        Try
            ...
            lbl_numero.Text = dgv_detalle_prog_despacho.CurrentRow.Cells("NOP").Value
            dtp_fecha_pedido.Value = dgv_detalle_prog_despacho.CurrentRow.Cells("FechaEntrega").Value
    ...
    Private Sub Button37_Click(sender As Object, e As EventArgs) Handles Button37.Click
        ...
        Try
            If MsgBox("Esta seguro de actualizar el Correlativo de los Despachos Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                ...
                If clsPedidoBl.Guardar_Act_Correlativo_Programacion_Despacho_Oficial(MantenimientoOP_Lista) Then
                    MsgBox("Actualización de Programación de Despachos Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
                    dgv_detalle_despachos_programados.DataSource = Nothing
                    dtp_fi_dp.Value = LibComunVar.ClsVarComun.FechaSistema
                    dtp_ff_dp.Value = ModFunciones.Ultimo_Dia_Mes(Date.Now)
                    Button50.Focus()
    ...
    Private Sub dgv_detalle_prog_despacho_CellClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgv_detalle_prog_despacho.CellClick
        If dgv_detalle_prog_despacho.CurrentRow Is Nothing Then Exit Sub
        If String.IsNullOrEmpty(dgv_detalle_prog_despacho.CurrentRow.Cells("NOP").Value) Then Exit Sub
        Dim CodigoCliente As String = ""
        CodigoCliente = dgv_detalle_prog_despacho.CurrentRow.Cells("NOP").Value
        MostrarModoConsultar(CodigoCliente)
    End Sub

    Private Sub MostrarModoConsultar(ByVal DOCUMENT_ID As String)
        Try
            clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
            ...
            'clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
            dtdetalleArticuloPrincipal = clsPedidoBl.Modo_Edicion_Detalle_Pedidos_Prog_Despacho(DOCUMENT_ID)
            ...
            If dtdetalleArticuloPrincipal.Rows.Count() <> 0 Then
                ...
                dgvDetalle.Columns("CANTIDAD_HABILITADO").HeaderText = "CANTIDAD HABILITADO DESPACHO"
                dgvDetalle.Columns("CANTIDAD_FACTURADO").Visible = False '.HeaderText = "CANTIDAD FACTURADO"
                ...
                dgvDetalle.Columns("ESTADO_OP").Visible = False '.HeaderText = "ESTADO REQ. O.P."
                dgvDetalle.Columns("NUMERO_OP").Visible = False '.HeaderText = "N° REQ. O.P."
                dgvDetalle.Columns("CODIGO_INTERNO").Visible = False '.HeaderText = "N° REQ. O.P."
                dgvDetalle.Columns("EMPRESA").Visible = False '.HeaderText = "N° REQ. O.P."
    ...
    Private Sub txt_cod_trans_cambio_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_trans_cambio.MouseDoubleClick
        Call Ayuda_Transportista(txt_cod_trans_cambio, txt_des_trans_cambio)
    End Sub

    Private Sub txt_cod_trans_cambio_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_trans_cambio.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Transportista(txt_cod_trans_cambio, txt_des_trans_cambio)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_trans.Text = "" Then
                Ayuda_Transportista(txt_cod_trans_cambio, txt_des_trans_cambio)
    ...
    Private Sub txt_cod_vehiculo_cambio_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_vehiculo_cambio.MouseDoubleClick
        Call Ayuda_Vehiculo(txt_cod_vehiculo_cambio, txt_des_vehiculo_cambio)
    End Sub

    Private Sub txt_cod_vehiculo_cambio_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_vehiculo_cambio.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Vehiculo(txt_cod_vehiculo_cambio, txt_des_vehiculo_cambio)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_vehiculo.Text = "" Then
                Ayuda_Vehiculo(txt_cod_vehiculo_cambio, txt_des_vehiculo_cambio)
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            If MsgBox("Esta seguro de Actualizar el Transportista y Vehiculo de los Despachos Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                ...
                If clsPedidoBl.Guardar_Act_Trans_Vehiculo_Programacion_Despacho_Oficial(MantenimientoOP_Lista, txt_cod_trans_cambio.Text, txt_cod_vehiculo_cambio.Text) Then

                    MsgBox("Actualización de Trans. y Vehiculo en la Programación de O.P. Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
                    dgv_detalle_despachos_programados.DataSource = Nothing
                    dtp_fi_dp.Value = LibComunVar.ClsVarComun.FechaSistema
                    dtp_ff_dp.Value = ModFunciones.Ultimo_Dia_Mes(Date.Now)
                    gb_cambio_trans_vehiculo.Visible = False
                    Button50.Focus()
                    Me.Cursor = Cursors.Default
                End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            If MsgBox("Esta seguro de cambiar el Transportista y Vehiculo a los Despachos Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                txt_cod_trans_cambio.Text = ""
                txt_des_trans_cambio.Text = ""
                txt_cod_vehiculo_cambio.Text = ""
                txt_des_vehiculo_cambio.Text = ""
                gb_cambio_trans_vehiculo.Visible = True
                txt_cod_trans_cambio.Focus()
            End If
        Catch ex As Exception
            MsgBox(ex.Message)
        End Try
    ...
    Private Sub txt_cod_trans_consulta_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_trans_consulta.MouseDoubleClick
        Call Ayuda_Transportista(txt_cod_trans_consulta, txt_des_trans_consulta)
    End Sub

    Private Sub txt_cod_trans_consulta_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_trans_consulta.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Transportista(txt_cod_trans_consulta, txt_des_trans_consulta)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_trans_consulta.Text = "" Then
                Ayuda_Transportista(txt_cod_trans_consulta, txt_des_trans_consulta)
            End If
        End If
    End Sub

    Private Sub txt_cod_vehiculo_consulta_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_vehiculo_consulta.MouseDoubleClick
        Call Ayuda_Vehiculo(txt_cod_vehiculo_consulta, txt_des_vehiculo_consulta)
    End Sub

    Private Sub txt_cod_vehiculo_consulta_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_vehiculo_consulta.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Vehiculo(txt_cod_vehiculo_consulta, txt_des_vehiculo_consulta)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_vehiculo.Text = "" Then
                Ayuda_Vehiculo(txt_cod_vehiculo_consulta, txt_des_vehiculo_consulta)
    ...
    Private Sub chk_todos_trans_CheckedChanged(sender As Object, e As EventArgs) Handles chk_todos_trans.CheckedChanged
        If chk_todos_trans.Checked Then
            txt_cod_trans_consulta.Text = ""
            txt_des_trans_consulta.Text = ""
            txt_cod_trans_consulta.Enabled = False
        Else
            txt_cod_trans_consulta.Text = ""
            txt_des_trans_consulta.Text = ""
            txt_cod_trans_consulta.Enabled = True
        End If
    End Sub

    Private Sub chk_todos_vehiculo_CheckedChanged(sender As Object, e As EventArgs) Handles chk_todos_vehiculo.CheckedChanged
        If chk_todos_vehiculo.Checked Then
            txt_cod_vehiculo_consulta.Text = ""
            txt_des_vehiculo_consulta.Text = ""
            txt_cod_vehiculo_consulta.Enabled = False
        Else
            txt_cod_vehiculo_consulta.Text = ""
            txt_des_vehiculo_consulta.Text = ""
            txt_cod_vehiculo_consulta.Enabled = True
        End If
    End Sub

    Private Sub chk_todos_estado_CheckedChanged(sender As Object, e As EventArgs) Handles chk_todos_estado.CheckedChanged
        If chk_todos_estado.Checked Then
            txt_cod_estado.Text = ""
            txt_des_estado.Text = ""
            txt_cod_estado.Enabled = False
        Else
            txt_cod_estado.Text = ""
            txt_des_estado.Text = ""
            txt_cod_estado.Enabled = True
        End If
    End Sub

    Private Sub txt_cod_estado_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_estado.MouseDoubleClick
        Call Ayuda_Estado(txt_cod_estado, txt_des_estado)
    End Sub

    Private Sub txt_cod_estado_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_estado.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Estado(txt_cod_estado, txt_des_estado)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_estado.Text = "" Then
                Ayuda_Estado(txt_cod_estado, txt_des_estado)
            End If
        End If
    End Sub

    Private Sub Ayuda_Estado(ByVal cod As TextBox, ByVal des As TextBox)
        Try
            Dim frm As New frmBuscar
            Dim sql As String = String.Empty
            sql = "CX_SP_S_ESTADOS_DESPACHOS_AYU"
            frm.CadenaConsulta = sql
            frm.Titulo = "Estado"
            frm.ShowDialog()
            If frm.Data_Matriz.Rows.Count > 0 Then
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Dim FR As New Frm_OP_PLanta_Bandeja_Programacion_Despachos_Prog_Recojo
        FR.ShowDialog()
    End Sub
    ...
    Private Sub btn_confirmar_Click(sender As Object, e As EventArgs) Handles btn_confirmar.Click
        ...
        Dim Estado As Boolean = False
        For Each row2 As DataRow In dtdetalleArticuloPrincipal.Select("Sel=true")
            Estado = True
            Exit For
        Next
        If Estado = False Then
        ...
        For Each row2 As DataRow In dtdetalleArticuloPrincipal.Select("Sel=true")
            If row2("SALDO") > row2("CANTIDAD_MAXIMA") Then
                MsgBox("La cantidad habilitada en el item " & row2("ITEM") & " supera el saldo. Verifique!!!", MsgBoxStyle.Exclamation)
                Exit Sub
            End If
        ...
        Codigo = dgvDetalle.CurrentRow.Cells("CODIGO_INTERNO").Value
        'Borrando los Datos
        For Each item As DataRow In dtdetalleArticuloPrincipal_Incripciones_RegSanit.Select("CODIGO_INTERNO=" & Codigo)
            item.Delete()
        ...
        For Each row As DataRow In dtdetalleArticuloPrincipal.Select("Sel=true")
            Dim row3 As DataRow = dtdetalleArticuloPrincipal_Incripciones_RegSanit.NewRow
            row3("CODIGO_INTERNO") = row("CODIGO_INTERNO")
            row3("ITEM") = row("ITEM")
            row3("CODIGO") = row("CODIGO")
            row3("CANTIDAD") = row("SALDO")
            row3("PART_DESCRIPTION") = row("DESCRIPCION")
            row3("UNIT") = row("UNIDAD")
            row3("EMPRESA") = row("EMPRESA")

            dtdetalleArticuloPrincipal_Incripciones_RegSanit.Rows.Add(row3)
            dtdetalleArticuloPrincipal_Incripciones_RegSanit.AcceptChanges()
        Next
    ...
    Private Sub Button6_Click(sender As Object, e As EventArgs) Handles Button6.Click
        Try
            ...
            STRPedido = dgv_detalle_prog_despacho.CurrentRow.Cells("NOP").Value
    ...
    Private Sub txt_responsable_despacho_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_responsable_despacho.MouseDoubleClick
        Ayuda_Usuario()
    End Sub

    Private Sub txt_responsable_despacho_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_responsable_despacho.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Usuario()
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_responsable_despacho.Text = "" Then
                Ayuda_Usuario()
            Else
                txt_vehiculo_despacho.Focus()
            End If
        End If
    End Sub
    ...
    Private Sub Ayuda_Usuario()
        Try
            ...
            frm.ShowDialog()
            If frm.Data_Matriz.Rows.Count > 0 Then
                txt_responsable_despacho.Text = frm.Data_Matriz.Rows(0).Item(1).ToString
            Else
                txt_responsable_despacho.Text = ""
            End If
            frm.Close()
    ...
    Private Sub txt_vehiculo_despacho_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_vehiculo_despacho.MouseDoubleClick
        Call Ayuda_Vehiculo(txt_vehiculo_despacho, txt_vehiculo_despacho)
    End Sub

    Private Sub txt_vehiculo_despacho_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_vehiculo_despacho.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Vehiculo(txt_vehiculo_despacho, txt_vehiculo_despacho)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_vehiculo_despacho.Text = "" Then
                Ayuda_Vehiculo(txt_vehiculo_despacho, txt_vehiculo_despacho)
            End If
        End If
    End Sub
