...
Imports System.IO
Public Class Frm_OP_PLanta_Bandeja_Despachos
    ...
    Private Sub Frm_OP_PLanta_Bandeja_Despachos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Consulta_Despachos()
        Try
            ...
            dt_detalle_programa_despachos = clsPedidoBl.get_Mantenimiento_Despachos(txt_cod_linea_produccion.Text, _cod_familia)
    ...
    Private Sub btn_prog_despacho_final_Click(sender As Object, e As EventArgs) Handles btn_prog_despacho_final.Click
        ...
        Try
            If MsgBox("Esta seguro de registrar la Programación de O.P.?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                ...
                For i As Integer = 0 To dgv_detalle_prog_despacho.Rows.Count - 1
                    If dgv_detalle_prog_despacho.Rows(i).Cells("SEL").Value Then
                        ...
                        With PedidoCabENT
                            ...
                            .TIPO_ORDEN = dgv_detalle_prog_despacho.Rows(i).Cells("TIPO_ORDEN").Value
                            .ESTADO_DESPACHO = "SI"
                            .FECHA_DESPACHO = dtp_fecha_despacho.Value.ToString("dd/MM/yyyy")
                            .CANTIDAD_DESPACHO = dgv_detalle_prog_despacho.Rows(i).Cells("Cantidad").Value
                            .PUNTO_SALIDA_DESPACHO = dgv_detalle_prog_despacho.Rows(i).Cells("PuntodeSalida").Value
                            .OBSERVACIONES_DESPACHO = dgv_detalle_prog_despacho.Rows(i).Cells("Observaciones").Value
                            .USER_ID_DESPACHO = LibComunVar.ClsVarComun.USUARIO
                            .ITEM_DESPACHO = dgv_detalle_prog_despacho.Rows(i).Cells("SecDespacho").Value
                            .HORA_ENTREGA_ACORDADO = dgv_detalle_prog_despacho.Rows(i).Cells("HrEntregaAcordado").Value
                            .COD_EQUIPO = txt_cod_equipo.Text
                            'Vendedor
                            If opt_vendedor <> dgv_detalle_prog_despacho.Rows(i).Cells("Vendedor").Value Then
                                opt_vendedor = dgv_detalle_prog_despacho.Rows(i).Cells("Vendedor").Value
                                ...
                                If existe_vendedor = False Then
                                    ...
                                    row("CORREO") = dgv_detalle_prog_despacho.Rows(i).Cells("Email").Value
                                    dt_vendedores.Rows.Add(row)
                                    dt_vendedores.AcceptChanges()

                                End If
                                existe_vendedor = False
                            End If

                            Dim row2 As DataRow = dtdetalle_despacho_correo.NewRow
                            row2("NOP") = dgv_detalle_prog_despacho.Rows(i).Cells("NOP").Value
                            row2("FechaEntrega") = dtp_fecha_despacho.Value.ToString("dd/MM/yyyy")
                            row2("Cliente") = dgv_detalle_prog_despacho.Rows(i).Cells("Cliente").Value
                            row2("Producto") = dgv_detalle_prog_despacho.Rows(i).Cells("Producto").Value
                            row2("Cantidad") = dgv_detalle_prog_despacho.Rows(i).Cells("Cantidad").Value
                            row2("HrEntregaAcordado") = ""
                            row2("HrMaximoEntrega") = "" 'dgv_detalle_prog_despacho.Rows(i).Cells("Email").Value
                            row2("PuntodeSalida") = dgv_detalle_prog_despacho.Rows(i).Cells("PuntodeSalida").Value
                            row2("Observaciones") = dgv_detalle_prog_despacho.Rows(i).Cells("Observaciones").Value
                            row2("VENDEDOR") = dgv_detalle_prog_despacho.Rows(i).Cells("Vendedor").Value
                ...
                If clsPedidoBl.Guardar_Programacion_Despacho(MantenimientoOP_Lista) Then
                    MsgBox("Programación de Orden de Producción Generado Correctamente.", MsgBoxStyle.Information, "Sistemas")
    ...
    Private Function Validar_Programacion_Despacho() As Boolean
        Try
            ...
            If txt_cod_equipo.Text = "" Then
                MessageBox.Show("Debe elegir un Equipo.", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Stop)
                txt_cod_equipo.Focus()
                Return False
            End If
    ...
    Private Sub Button50_Click(sender As Object, e As EventArgs) Handles Button50.Click
        Try
            ...
            'If txt_cod_equipo_consulta.Text = "" Then
            '    MsgBox("Debe elegir un Equipo.", MsgBoxStyle.Exclamation)
            '    Exit Sub
            'End If
            ...
            dt_detalle_despachos_programados = clsPedidoBl.get_Mantenimiento_Despachos_Programados(dtp_fi_dp.Value.ToString("dd/MM/yyyy"),
                                                                                                   dtp_ff_dp.Value.ToString("dd/MM/yyyy"),
                                                                                                   txt_cod_linea_produccion_2.Text,
                                                                                                   txt_cod_equipo_consulta.Text, _cod_familia)
            dgv_detalle_despachos_programados.DataSource = Nothing
            gb_cambio_depachos_programados.Visible = False
            If dt_detalle_despachos_programados.Rows.Count() <> 0 Then
                ...
                dgv_detalle_despachos_programados.Columns(5).Width = 70
                ...
                dgv_detalle_despachos_programados.Columns(9).Width = 70
                dgv_detalle_despachos_programados.Columns(10).Width = 80
                ...
                dgv_detalle_despachos_programados.Columns("DISPENSADO").HeaderText = "Estado Dispensación"
                dgv_detalle_despachos_programados.Columns("DISPENSADO").Width = 120

                dgv_detalle_despachos_programados.Columns("CANTIDAD_PRODUCIDA").HeaderText = "Cantidad Producida"
                dgv_detalle_despachos_programados.Columns("CANTIDAD_PRODUCIDA").Width = 120
                dgv_detalle_despachos_programados.Columns("CANTIDAD_PRODUCIDA").DefaultCellStyle.Format = "N2"
                dgv_detalle_despachos_programados.Columns("CANTIDAD_PRODUCIDA").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                dgv_detalle_despachos_programados.Columns("ITEM").Visible = False
                dgv_detalle_despachos_programados.Columns("Estado_Liquidacion").HeaderText = "Estado Liquidación"
                dgv_detalle_despachos_programados.Columns("Estado_Liquidacion").Width = 150

                dgv_detalle_despachos_programados.Columns("TIPO_ORDEN").HeaderText = "Tipo Orden"
                dgv_detalle_despachos_programados.Columns("TIPO_ORDEN").Width = 80

                dgv_detalle_despachos_programados.Columns("DIFERENCIA_CANTIDADES").Width = 100
                dgv_detalle_despachos_programados.Columns("DIFERENCIA_CANTIDADES").HeaderText = "Diferencia de Cantidades"
                dgv_detalle_despachos_programados.Columns("DIFERENCIA_CANTIDADES").DefaultCellStyle.Format = "N2"
                dgv_detalle_despachos_programados.Columns("DIFERENCIA_CANTIDADES").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight

                dgv_detalle_despachos_programados.Columns("PORCENTAJE_PRODUCCION").Width = 100
                dgv_detalle_despachos_programados.Columns("PORCENTAJE_PRODUCCION").HeaderText = "% Producción"
                dgv_detalle_despachos_programados.Columns("PORCENTAJE_PRODUCCION").DefaultCellStyle.Format = "N2"
                dgv_detalle_despachos_programados.Columns("PORCENTAJE_PRODUCCION").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
    ...
    Private Sub Button38_Click(sender As Object, e As EventArgs) Handles Button38.Click
        Try
            ...
            If dt_detalle_despachos_programados.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("rpt_Formato_Despacho.rpt", dt_detalle_despachos_programados, "", "", _
                                                  "@FECHA_INICIO;" & dtp_fi_dp.Value.ToString("dd/MM/yyyy"), _
                                                  "@FECHA_FIN;" & dtp_ff_dp.Value.ToString("dd/MM/yyyy"), _
                                                  "@LINEA_PRODUCCION;" & txt_cod_linea_produccion_2.Text, _
                                                  "@equipo;" & txt_cod_equipo_consulta.Text, _
                                                  "@cod_familia;" & _cod_familia, _
    ...
    Private Sub Button47_Click(sender As Object, e As EventArgs) Handles Button47.Click
        ...
        Try
            If MsgBox("Esta seguro de cambiar de Fecha a las O.P. Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
    ...
    Private Sub Button48_Click(sender As Object, e As EventArgs) Handles Button48.Click
        ...
        Try
            If MsgBox("Esta seguro de extornar la Programación de O.P. elegida?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                ...
                For i As Integer = 0 To dgv_detalle_despachos_programados.Rows.Count - 1
                    If dgv_detalle_despachos_programados.Rows(i).Cells("SEL").Value Then
                        ...
                        With PedidoCabENT
                            .ID = dgv_detalle_despachos_programados.Rows(i).Cells("CODIGO_INTERNO").Value
                            .TIPO_ORDEN = dgv_detalle_despachos_programados.Rows(i).Cells("TIPO_ORDEN").Value
                ...
                If clsPedidoBl.Guardar_Deshacer_Programacion_Despacho(MantenimientoOP_Lista) Then
    ...
    Private Sub Button34_Click(sender As Object, e As EventArgs) Handles Button34.Click
        Try
            ...
            If MsgBox("Esta seguro de Actualizar la Fecha de las O.P. Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
                ...
                If clsPedidoBl.Guardar_Act_Fecha_Programacion_Despacho(MantenimientoOP_Lista) Then
    ...
    Private Sub txt_cantidad_manual_KeyPress(sender As Object, e As KeyPressEventArgs) Handles txt_cantidad_liquidacion.KeyPress
    ...
    Private Sub Button37_Click(sender As Object, e As EventArgs) Handles Button37.Click
        ...
        Try
            If MsgBox("Esta seguro de actualizar el Correlativo de las O.P. Programados?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                clsPedidoBl = New LibManufactura.ClsOperaciones.ORDERS
                Dim MantenimientoOP_Lista As New List(Of ClsEntidades.MANTENIMIENTO_OP)
    ...
    Private Sub txt_cod_equipo_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_equipo.MouseDoubleClick
        Ayuda_Equipos(txt_cod_equipo, txt_des_equipo)
    End Sub

    Private Sub txt_cod_equipo_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_equipo.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Equipos(txt_cod_equipo, txt_des_equipo)
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_equipo.Text.Trim = "" Then
                Ayuda_Equipos(txt_cod_equipo, txt_des_equipo)
            End If
        End If
    End Sub
    ...
    Private Sub txt_cod_equipo_consulta_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_equipo_consulta.MouseDoubleClick
        Ayuda_Equipos(txt_cod_equipo_consulta, txt_des_equipo_consulta)
    End Sub

    Private Sub txt_cod_equipo_consulta_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_equipo_consulta.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Equipos(txt_cod_equipo_consulta, txt_des_equipo_consulta)
        End If
        If e.KeyCode = Keys.Enter Then
    ...
    Private Sub TextBox2_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txt_cod_linea_consulta.MouseDoubleClick
        Ayuda_Linea_Produccion_Consulta()
    End Sub

    Private Sub TextBox2_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_cod_linea_consulta.KeyDown
        If e.KeyCode = Keys.F1 Then
            Ayuda_Linea_Produccion_Consulta()
        End If
        If e.KeyCode = Keys.Enter Then
            If txt_cod_linea_consulta.Text.Trim = "" Then
                Ayuda_Linea_Produccion_Consulta()
            End If
        End If
    End Sub

    Private Sub Ayuda_Linea_Produccion_Consulta()
        Try
            Dim frm As New frmBuscar
            Dim sql As String = String.Empty
            _cod_familia = ""
            ...
            frm.ShowDialog()
            If frm.Data_Matriz.Rows.Count > 0 Then
                txt_cod_linea_consulta.Text = frm.Data_Matriz.Rows(0).Item(0)
                txt_des_linea_consulta.Text = frm.Data_Matriz.Rows(0).Item(1).ToString
                _cod_familia = frm.Data_Matriz.Rows(0).Item("COD_FAMILIA").ToString
            Else
                txt_cod_linea_consulta.Text = ""
                txt_des_linea_consulta.Text = ""
                _cod_familia = ""
            End If
            frm.Close()
        Catch ex As Exception
    ...
    Private Sub LiquidarOrdenDeProducciónToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LiquidarOrdenDeProducciónToolStripMenuItem.Click
        ...
        dtp_fecha_liquidacion.Value = Date.Now
        txt_cantidad_liquidacion.Text = ""
        pnl_liquidación.Visible = True
        pnl_liquidación.BringToFront()
        txt_cantidad_liquidacion.Focus()
    End Sub

    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles btn_cancelar_liquidacion.Click
        pnl_despachos_programados.Enabled = True
        pnl_liquidación.Visible = False
    End Sub

    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btn_confirmar_liquidacion.Click
        If txt_cantidad_liquidacion.Text = "" Then
            MsgBox("Debe indicar una cantidad a liquidar.", MsgBoxStyle.Exclamation)
            Exit Sub
        ElseIf CDbl(txt_cantidad_liquidacion.Text) = 0 Then
            MsgBox("Debe indicar una cantidad diferente de cero.", MsgBoxStyle.Exclamation)
            Exit Sub
        End If
        Try
            If MsgBox("Esta seguro de generar la Liquidación de la Orden de Producción elegida?", MsgBoxStyle.Question + MsgBoxStyle.YesNo, "Cuidado!") = MsgBoxResult.Yes Then
                Me.Cursor = Cursors.WaitCursor
                ...
                With alm_cabBE
                    .ID = dgv_detalle_despachos_programados.CurrentRow.Cells("N° O.P.").Value
                End With

                alm_detBE = New ClsEntidades.PRODUCCION_OP_LIQUIDACION
                With alm_detBE
                    .ID_CAB = alm_cabBE.ID
                    .ITEM = dgv_detalle_despachos_programados.CurrentRow.Cells("ITEM").Value 'row("ITEM")
                    If rdb_parcial.Checked Then
                        .TIPO = rdb_parcial.Text
                    ElseIf rdb_total.Checked Then
                        .TIPO = rdb_total.Text
                    End If

                    .COSTO = 0
                    .CANTIDAD = CDbl(txt_cantidad_liquidacion.Text)
                    .WAREHOUSE_REF = ""
                    .DOCUMENT_REF = ""
                    .NUMBER_DOCUMENT_REF = ""
                    .FECHA_REF = dtp_fecha_liquidacion.Value.ToString("dd/MM/yyyy")
                    .USER_ID = LibComunVar.ClsVarComun.USUARIO
                    .ITEM_PRODUCTO = dgv_detalle_despachos_programados.CurrentRow.Cells("ITEM").Value
                End With
