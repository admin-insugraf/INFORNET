Public Class Frm_OP_Planta_Preparacion_Especial_Equipo
    ...
    Private Sub Frm_OP_Planta_Preparacion_Especial_Equipo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Motivos_Act_No_Programada()
        ...
        cbo_motivo.DataSource = monedaBL.get_Preparacion_Especial_Equipo(maquina)
    ...
    Private Sub Lista_Historial_Personal()
        Try
            ...
            dtdetalleArticuloPrincipal = clsPedidoBl.get_Parte_Produccion_Historial_Personal_Preparacion_Especial(maquina, fecha, turno)
    ...
    Public Sub Formato_Grillas()
        If dtdetalleArticuloPrincipal.Rows.Count > 0 Then
            ...
            dgv_detalle_hp.Columns(3).HeaderText = "Preparación Especial"
            dgv_detalle_hp.Columns(4).Visible = False '.HeaderText = "N° O.P."
    ...
    Private Function Agregar_HP(ByVal _item As Integer) As Boolean
        Try
            ...
            With Pedido_Det_HP
                ...
                .NUMERO_OP = "Preparación Especial de Equipo"
                .EQUIPO_COD = maquina
            ...
            If clsPedidoBl.Guardar_Parte_Produccion_Historial_Personal_Preparacion_Especial_Equipo(Pedido_Det_HP) = False Then
                MsgBox("PREPARACION ESPECIAL DE EQUIPO no se registro.", MsgBoxStyle.Exclamation, "Sistemas")
                Me.Cursor = Cursors.Default
                Return False
            Else
                Lista_Historial_Personal()
    ...
    Function Validacion_HP() As Boolean
        ...
        '    MsgBox("Debe elegir un motivo de la PREPARACION ESPECIAL DEL EQUIPO", MsgBoxStyle.Exclamation, "Sistemas")
        '    Return False
        '    Exit Function
        'End If

        If txt_descripcion_hp.Text.Trim = "" Then
            MsgBox("Debe digitar una observación de la PREPARACION ESPECIAL DEL EQUIPO", MsgBoxStyle.Exclamation, "Sistemas")
            Return False
            Exit Function
        End If
