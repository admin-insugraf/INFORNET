...
Public Class Frm_Procesos_Produccion
    ...
    Private Sub Frm_Procesos_Produccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Datos()
        ...
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Lista_Procesos_Produccion()
    ...
    Private Sub Obtener_Codigo()
        ...
        dtdetalles = New DataTable("Datos")
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Codigo_Proceso_Produccion()
        If dtdetalles.Rows.Count() > 0 Then
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        Try
            ...
            If bol_nuevo Then
                ...
                dtdetalles_validar = tipoPagoBL.get_Proceso_Produccion_Existe(txt_cod.Text.Trim)
            ...
            If bol_nuevo Then
                termsBL.Insert_Proceso_Produccion(termsBE)
            Else
                termsBL.Update_Proceso_Produccion(termsBE)
            End If
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        Try
            ...
            If Preguntar("Seguro de eliminar?") Then
                ...
                termsBL.Delete_Proceso_Produccion(termsBE)
                termsBE = Nothing
                termsBL = Nothing
                Call Cargar_Datos()
                Call Avisar("Proceso generado correctamente!")
