...
Public Class Frm_Equipos_Maquinaria
    ...
    Private Sub Frm_Equipos_Maquinaria_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Datos()
        ...
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Lista_Equipos()
        If dtdetalles.Rows.Count() <> 0 Then
            ...
            dgv_Lista.Columns(2).HeaderText = "Codigo Equipo"
    ...
    Private Sub Obtener_Codigo()
        ...
        dtdetalles = New DataTable("Datos")
        dtv = New DataView
        dtdetalles = tipoPagoBL.get_Codigo_Lista_Equipo()
        If dtdetalles.Rows.Count() > 0 Then
    ...
    Private Sub btn_grabar_Click(sender As Object, e As EventArgs) Handles btn_grabar.Click
        Try
            ...
            If bol_nuevo Then
                ...
                dtdetalles_validar = tipoPagoBL.get_Lista_Equipos_Existe(txt_cod.Text.Trim)
                If dtdetalles_validar.Rows.Count() <> 0 Then
                    Me.Cursor = Cursors.Default
                    MsgBox("El codigo ingresdo ya existe. Verifique!!!", MsgBoxStyle.Critical)
                    Exit Sub
                End If
            End If
            ...
            With termsBE
                ...
                .CODIGO_EQUIPO = txt_codigo_equipo.Text
            End With

            If bol_nuevo Then
                termsBL.Insert_Lista_Equipos(termsBE)
            Else
                termsBL.Update_Lista_Equipos(termsBE)
            End If
    ...
    Private Sub btn_Editar_Click(sender As Object, e As EventArgs) Handles btn_Editar.Click
        ...
        txt_codigo_equipo.Text = dgv_Lista.CurrentRow.Cells(2).Value.ToString
        CONTROLES(TabPage1, False)
        CONTROLES(TabPage2, True)
        Botonera_Estado_Cambiar(True)
        txt_des.Focus()
    ...
    Private Sub btn_eliminar_Click(sender As Object, e As EventArgs) Handles btn_eliminar.Click
        ...
        Try
            ...
            If Preguntar("Seguro de eliminar?") Then
                ...
                termsBL.Delete_Lista_Equipos(termsBE)
                termsBE = Nothing
                termsBL = Nothing
                Call Cargar_Datos()
                Call Avisar("Proceso generado correctamente!")
    ...
    Private Sub txt_codigo_equipo_KeyDown(sender As Object, e As KeyEventArgs) Handles txt_codigo_equipo.KeyDown
        If e.KeyCode = Keys.Enter Then
