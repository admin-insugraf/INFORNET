...
Public Class frmGuiaAnalisis
    ...
    Private Sub frmGuiaAnalisis_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ModificandoArticulos()
        Try
            Dim frmArticulo As New FrmDetalleGuiaAnalisis
