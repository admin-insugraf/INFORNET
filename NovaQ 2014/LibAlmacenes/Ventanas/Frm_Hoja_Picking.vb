...
Public Class Frm_Hoja_Picking

    Public _NRO_OF As String = String.Empty


    Dim Modo_consultar As Boolean = False
    Dim OrdenCompraCabENT As ClsEntidadesAlm.PURCHASE_ORDER
    Dim OrdenCompraDetENT As ClsEntidadesAlm.PURCHASE_ORDER_LINE
    Dim ListaDetalles As List(Of ClsEntidadesAlm.PURCHASE_ORDER_LINE)

    Dim OrdenCompraBl As ClsOperacionesAlm.PURCHASE_ORDER

    Dim CORRELATIVOBL As ClsTransaccionesAlm.PURCHASE_ORDER
    Dim dtv As DataView
    ...
    Private Sub DetalleInicialOrdenCompras()
        Try
            OrdenCompraBl = New ClsOperacionesAlm.PURCHASE_ORDER
    ...
    Private Sub Cargar_Moneda()
        Dim monedaBL As New ClsOperacionesAlm.CURRENCY_TYPE
    ...
    Private Sub Cargar_Porcen_IGV()
        Dim POR_IGVBL As New ClsOperacionesAlm.CURRENCY_TYPE
    ...
    Private Function Numeracion() As String
        ...
        Try
            CORRELATIVOBL = New ClsTransaccionesAlm.PURCHASE_ORDER
    ...
    Private Function Guardar_Orden_Compra() As Boolean
        Try
            OrdenCompraBl = New ClsOperacionesAlm.PURCHASE_ORDER
            OrdenCompraCabENT = New ClsEntidadesAlm.PURCHASE_ORDER
            ListaDetalles = New List(Of ClsEntidadesAlm.PURCHASE_ORDER_LINE)
            ...
            For Each item As DataRow In dtdetalleArticuloPrincipal.Rows
                OrdenCompraDetENT = New ClsEntidadesAlm.PURCHASE_ORDER_LINE
    ...
    Private Sub dtpemision_Leave(sender As Object, e As EventArgs) Handles dtpemision.Leave
        Try
            Dim cls_compras = New ClsOperacionesAlm.CURRENCY_TYPE
            Dim dt_tc As Double
    ...
    Private Sub Ayuda_Centro_Costo_Compras(Optional ByVal _codigo As String = "")
        Try
            ...
            '    frm.Close()
            'Else
            '    Dim clsArticuloBl As New LibCobranzas.ClsOperacionesAlm.PART
            '    Dim dtDocumentoGuias As New DataTable
