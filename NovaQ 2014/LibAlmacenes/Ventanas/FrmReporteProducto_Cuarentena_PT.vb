...
Public Class FrmReporteProducto_Cuarentena_PT
    ...
    Public Sub MostrarReportes(ByVal Fecha_ini As String, ByVal Fecha_fin As String, ByVal Familia As String, ByVal art_inicial As String, ByVal art_final As String)
        Try
            ...
            dtReporte = reporteBL.Imprimir_Ingresos_Cuarentena(Fecha_ini, Fecha_fin, Familia, art_inicial, art_final)
            If dtReporte.Rows.Count() <> 0 Then
                crystalBL.Muestra_Reporte("rpt_ingreso_cuarentena_PT.rpt", "", "", "", "@FECHA_INI;" & Fecha_ini, "@FECHA_FIN;" & Fecha_fin, "@FAMILIA;" & Familia, "@PROD_INI;" & art_inicial, "@PROD_FIN;" & art_final)
            Else
