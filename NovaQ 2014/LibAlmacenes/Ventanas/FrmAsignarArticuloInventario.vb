...
Public Class FrmAsignarArticuloInventario
    ...
    Private Sub ModoEdicion()
        Try
            ...
            If dtdetalleArticulo.Rows.Count() <> 0 Then
                ...
                cbonumanalisis.Text = dtdetalleArticulo.Rows(0).Item("NUMERO_ANALISIS").ToString
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If Flag_ModoEdicion = False Then
            ...
            row("NUMERO_ANALISIS") = cbonumanalisis.Text
    ...
    Private Sub PresionaEnter_KeyPress(ByVal sender As Object, _
       ByVal e As System.Windows.Forms.KeyPressEventArgs)
        ...
        If columna = 2 Then
            ...
            ' referencia a la celda  
            Dim txt As TextBox = CType(sender, TextBox)
            MsgBox("Caracter capturado" + caracter)
        End If
    End Sub

    Private Sub dataGridView_EditingControlShowing(ByVal sender As Object, ByVal e As DataGridViewEditingControlShowingEventArgs) Handles dgvDetallesBulto.EditingControlShowing
        ' referencia a la celda  
    ...
    Private Sub btnreplicar_Click(sender As Object, e As EventArgs) Handles btnreplicar.Click
        If dgvDetallesBulto.Rows.Count > 0 Then
            ...
            For i As Integer = 0 To txtnumerobultos.Text - 1
                'For i As Integer = 0 To txtnumerobultos.Text - 1
                dgvDetallesBulto.Rows.Add(i + 1, txtcantidad.Text, _cantidad_inicial)
                'Next
            Next
        End If
    End Sub
