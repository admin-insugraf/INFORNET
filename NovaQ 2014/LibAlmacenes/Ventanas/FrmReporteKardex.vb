...
Public Class FrmReporteKardex
    ...
    Public Sub AjustarTamaño()
        Select Case NombreReporte
            Case "ReporteKardexReferenciaArticulo"
                'Size = New System.Drawing.Size(442, 499)
                Me.gbArticulos.Visible = True
                Me.gbLotes.Visible = False
            Case "ReporteKardexReferenciaLote"
                'Size = New System.Drawing.Size(442, 499)
                'Me.gbLotes.Location = New Point(12, 299)
                Me.gbArticulos.Visible = False
                Me.gbLotes.Visible = True
        End Select
    End Sub
    ...
    Private Function ValidacionesLotes(ByRef IDE As String, ByRef fechaINI As String,
        ...
        Return estado
    End Function
    'Public Sub MostrarReportes(ByVal IDE As String, ByVal alma As String, ByVal fechaINI As String,
    ...
    '                        'For i As Integer = 1 To cboAlmacenes.Items.Count() - 1
    '                        '    cboAlmacenes.SelectedIndex = i
    '                        '    lista.Add(cboAlmacenes.SelectedValue.ToString)
    '                        'Next
    ...
    '                            'crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & "Todos los Almacenes")
    '                            crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                        Else
    '                            MsgBox("No hay informacion dispnible para Mostrar", MsgBoxStyle.Information, "Sistemas")
    '                        End If
    '                    ElseIf cboAlmacenes.SelectedIndex <> 0 Then
    '                        dtReporteKardex = New DataTable("articulos")
    '                        dtReporteKardex = reporteBL.Get_ImprimirReporte_Articulos(IDE, alma, fechaINI, fechaFIN, ART1, ART2, TODOSMOV, TODOS, mesAnt, anoAnt, mesActual, anoAct, LOTE)
    '                        If dtReporteKardex.Rows.Count() <> 0 Then
    '                            'If alma = "02" Or alma = "18" Or alma = "02" Or alma = "19" Or alma = "21" Then
    '                            '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                            'Else
    '                            '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text)
    '                            'End If
    '                            crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                        Else
    '                            MsgBox("No hay informacion dispnible para Mostrar", MsgBoxStyle.Information, "Sistemas")
    ...
    '                             "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                        Else
    '                            MsgBox("No hay informacion dispnible para Mostrar", MsgBoxStyle.Information, "Sistemas")
    '                        End If
    '                    ElseIf cboAlmacenes.SelectedIndex <> 0 Then
    '                        dtReporteKardex = New DataTable("articulos")
    '                        dtReporteKardex = reporteBL.Get_ImprimirReporte_Articulos_SIN_LOTE(IDE, alma, fechaINI, fechaFIN, ART1, ART2, TODOSMOV, TODOS, mesAnt, anoAnt, mesActual, anoAct, LOTE)
    '                        If dtReporteKardex.Rows.Count() <> 0 Then
    '                            'If alma = "02" Or alma = "18" Or alma = "02" Or alma = "19" Or alma = "21" Then
    '                            '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, _
    '                            '                           "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                            'Else
    '                            '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text)
    '                            'End If
    '                            crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, _
    '                                                     "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text, "@USER;" & ClsVarComun.USUARIO.ToUpper)
    '                        Else
    ...
    '                    If dtReporteKardex.Rows.Count() <> 0 Then
    '                        ''crystalBL.Muestra_Reporte("rpt_kardex_referencia_lotes.rpt", dtReporteKardex, "", "", "", "@LOTE_INI;" & LOTE, "@LOTE_FIN;" & LOTE, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & "Todos los Almacenes")
    ...
    '                    dtReporteKardex = reporteBL.Get_ImprimirReporte_Lotes(IDE, alma, fechaINI, fechaFIN, ART1, ART2, TODOSMOV, TODOS, mesAnt, anoAnt, mesActual, anoAct, LOTE)
    '                    If dtReporteKardex.Rows.Count() <> 0 Then
    '                        'If alma = "02" Or alma = "18" Or alma = "02" Or alma = "19" Or alma = "21" Then
    '                        '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_lotes_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@LOTE_INI;" & LOTE, "@LOTE_FIN;" & LOTE, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & "Todos los Almacenes")
    '                        'Else
    '                        '    crystalBL.Muestra_Reporte("rpt_kardex_referencia_lotes.rpt", dtReporteKardex, "", "", "", "@LOTE_INI;" & LOTE, "@LOTE_FIN;" & LOTE, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & cboAlmacenes.Text)
    '                        'End If
    '                        crystalBL.Muestra_Reporte("rpt_kardex_referencia_lotes_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@LOTE_INI;" & LOTE, "@LOTE_FIN;" & LOTE, "@FECHA_INI;" & dtpfechaInicio.Value, "@FECHA_FIN;" & dtpfechaFin.Value, "@ALMACEN;" & "Todos los Almacenes")
    '                    Else
    '                        MsgBox("No hay informacion dispnible para Mostrar", MsgBoxStyle.Information, "Sistemas")
                ...
                Case "ReporteKardexReferenciaArticulo"
                    ...
                    Else
                        ...
                        Else
                            If lista.Count() = 1 Then
                                dtReporteKardex = New DataTable("articulos")
                                dtReporteKardex = reporteBL.Get_ImprimirReporte_Articulos_SIN_LOTE(IDE, lista(0).ToString, fechaINI, fechaFIN, ART1, ART2, TODOSMOV, TODOS, mesAnt, anoAnt, mesActual, anoAct, LOTE)
                                If dtReporteKardex.Rows.Count() <> 0 Then
                                    crystalBL.Muestra_Reporte("rpt_kardex_referencia_articulo_Materia_Prima.rpt", dtReporteKardex, "", "", "", "@ART_INI;" & ART1, "@ART_FIN;" & ART2, _
    ...
    Private Sub txtLoteInicial_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles txtLoteInicial.MouseDoubleClick
        Try
            Dim frm As New frmBuscar
            Dim sql As String = String.Empty
            sql = "ALM_SP_S_WAREHOUSE_LOTE_AYUDA"
            frm.CadenaConsulta = sql
            frm.Titulo = "Lotes"
            frm.ShowDialog()
            If frm.Data_Matriz.Rows.Count > 0 Then
                txtLoteInicial.Text = frm.Data_Matriz.Rows(0).Item(0)
            End If
            frm.Close()
        Catch ex As Exception
            MsgBox(ex.Message)
