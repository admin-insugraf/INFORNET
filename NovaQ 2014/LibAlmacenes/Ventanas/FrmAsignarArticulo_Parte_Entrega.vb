...
Public Class FrmAsignarArticulo_Parte_Entrega
    ...
    Dim _AREA As String
    Dim _NUMERO_LOTE As String
    Dim _F_VENCIMIENTO As String
    Dim _F_FABRICACION As String

    Private Sub FrmAsignarArticulo_Parte_Entrega_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        If Flag_ModoEdicion = False Then
            ...
            row("LOTE") = _NUMERO_LOTE
            row("F_VENCIMIENTO") = _F_VENCIMIENTO
            row("F_FABRICACION") = _F_FABRICACION
            ...
            row("AREA") = _AREA 'cbonumanalisis.Text
    ...
    Private Sub txtcantidad_KeyDown(sender As Object, e As KeyEventArgs) Handles txtcantidad.KeyDown
        If e.KeyCode = Keys.Enter Then
            txt_observaciones.Focus() 'btnAceptar_Click(sender, e)
        End If
    End Sub
    ...
    Public Sub GenerarColummnaDataTable()
        Try
            ...
            dtdetalleArticulo.Columns.Add("AREA", Type.GetType("System.String"))
    ...
    Private Sub ModoEdicion()
        Try
            ...
            If dtdetalleArticulo.Rows.Count() <> 0 Then
                ...
                _NUMERO_LOTE = dtdetalleArticulo.Rows(0).Item("LOTE").ToString
                _F_VENCIMIENTO = dtdetalleArticulo.Rows(0).Item("F_VENCIMIENTO").ToString
                _F_FABRICACION = dtdetalleArticulo.Rows(0).Item("F_FABRICACION").ToString
                ...
                _AREA = dtdetalleArticulo.Rows(0).Item("AREA").ToString
    ...
    Private Sub Mostrando_Ops(ByVal TipoMovimiento As String)
        Try
            ...
            If frm.Data_Matriz.Rows.Count > 0 Then
                ...
                _AREA = frm.Data_Matriz.Rows(0).Item("AREA").ToString
                Dim codigoArticulo As String = String.Empty
                codigoArticulo = txtcodigoArticulo.Text.Trim
                AgregarArticuloManual(codigoArticulo)
                txtcantidad.Focus()
