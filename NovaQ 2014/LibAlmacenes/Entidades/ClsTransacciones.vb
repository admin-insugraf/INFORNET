...
Public Class ClsTransacciones
    ...
    Public Class clsMostrarTiposMovimiento
        ...
        Private _IS_LOTE_A_FABRICAR As String
        ...
        Public Property IS_LOTE_A_FABRICAR As String
            Get
                Return _IS_LOTE_A_FABRICAR
            End Get
            Set(value As String)
                _IS_LOTE_A_FABRICAR = value
            End Set
        End Property
            ...
            Try
                ...
                If dtTransaccion.Rows.Count() <> 0 Then
                    For i As Integer = 0 To dtTransaccion.Rows.Count() - 1
                        ...
                        IS_LOTE_A_FABRICAR = dtTransaccion.Rows(i).Item("IS_LOTE_A_FABRICAR").ToString
                        IS_COD_ARTICULO = dtTransaccion.Rows(i).Item("IS_COD_ARTICULO").ToString
                    Next
                End If
    ...
    Public Class clsAlmacenCorrelativo
        ...
        Public Sub Get_NumeroCorrelativoAlmacen()
            Try
                Dim dtguiaAnalisis As New DataTable
                dtguiaAnalisis = SqlHelper.ExecuteDataset(cn, CommandType.StoredProcedure, "ALM_SP_S_WAREHOUSE_CORRELATIVO").Tables(0)
                For i As Integer = 0 To dtguiaAnalisis.Rows.Count() - 1
