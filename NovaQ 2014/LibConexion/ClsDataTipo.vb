...
Public Class ClsDataTipo
    ...
    Private Sub ColeccionParametro(ByRef CmdComando As SqlClient.SqlCommand, ByVal ParamArray argparams() As Object)
        ...
        For INTval = 0 To myArrayParam.Count - 1
            ...
            oParam.Direction = CType(myArrayParam(INTval), ArregloParam).STRInOut
    ...
    Public Function DatosParam(ByVal STRNombre As String, ByVal PTipo As System.Data.SqlDbType, _
                                ByVal INTtamano As Integer, ByVal oVal As Object, ByVal PInOut As System.Data.ParameterDirection, _
                                Optional ByVal BYTPrec As Byte = 0, Optional ByVal BYTScala As Byte = 0)
        myArrayParam.Add(New ArregloParam(STRNombre, PTipo, INTtamano, oVal, PInOut, BYTPrec, BYTScala))
    End Function
    Public Structure ArregloParam
        ...
        Public STRInOut As System.Data.ParameterDirection
        ...
        Public Sub New(ByVal nombre As String, ByVal tipo As System.Data.SqlDbType, ByVal Tamano As Integer, _
                       ByVal valor As Object, ByVal InOut As System.Data.ParameterDirection, _
                       ByVal Precision As Byte, ByVal Escala As Byte)
            STRnombre = nombre
            STRtipo = tipo
            INTTamano = Tamano
            OBJvalor = valor
    ...
    Public Function Run_Store_Procedure(ByVal STRsp As String, _
                                        ByRef objRetorno As Object, _
                                        ByVal STRNomPar As String, _
        ...
        Try
            ...
            'If Trim(objRetorno).Length > 0 Then
            objRetorno = cmdDatos.Parameters(STRNomPar).Value
            'End If
            myTrans.Commit()
            CnxSql.Close()
            Return True
