Public Class frm_AF_MA_ResponsableEje
    Dim bol_nuevo As Boolean = False
    Private Sub frm_AF_MA_ResponsableEje_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Cargar_Datos()
        Inicializa_Tool(ToolS_Mantenimiento)
    End Sub

    Private Sub Cargar_Datos()
        Dim cateBL As New ClsOperaciones.AF_MA_RESPO_EJE
    ...
    Private Sub Tool_Grabar_Click(sender As Object, e As EventArgs) Handles Tool_Grabar.Click
        ...
        Dim catBE As New ClsEntidades.AF_MA_RESPO_EJE
        Dim catBL As New ClsOperaciones.AF_MA_RESPO_EJE

        With catBE
            .RE_ID = txt_cod.Text.Trim
            .RE_DESCRIPCION = txt_des.Text.Trim
        End With
    ...
    Private Sub Tool_Editar_Click(sender As Object, e As EventArgs) Handles Tool_Editar.Click
        ...
        Cambiar_Estado_Tool(ToolS_Mantenimiento)
        txt_cod.Text = dgv_lista.CurrentRow.Cells("RE_ID").Value
        txt_des.Text = dgv_lista.CurrentRow.Cells("RE_DESCRIPCION").Value
    ...
    Private Sub Tool_Eliminar_Click(sender As Object, e As EventArgs) Handles Tool_Eliminar.Click
        ...
        If MsgBox("Seguro de Eliminar?", MsgBoxStyle.Question, "Cuidado!") = MsgBoxResult.Yes Then
            ...
            Dim catBL As New ClsOperaciones.AF_MA_RESPO_EJE
            With catBE
                .RE_ID = dgv_lista.CurrentRow.Cells("RE_ID").Value
            End With
            catBL.delete(catBE)
            catBE = Nothing
            catBL = Nothing
