...
Public Class frm_AF_MA_CentroCosto
    Dim bol_nuevo As Boolean = False
    Private Sub frm_AF_MA_CentroCosto_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Cargar_Datos()
        Dim cateBL As New ClsOperaciones.AF_MA_CENCOS
        dgv_lista.DataSource = cateBL.get_centros
        cateBL = Nothing
    End Sub
    ...
    Private Sub Tool_Grabar_Click(sender As Object, e As EventArgs) Handles Tool_Grabar.Click
        ...
        Dim catBE As New ClsEntidades.AF_MA_CENCOS
        Dim catBL As New ClsOperaciones.AF_MA_CENCOS

        With catBE
            .CC_ID = txt_cod.Text.Trim
            .CC_DESCRIPCION = txt_des.Text.Trim
            .CC_ESTADO = IIf(chk_estado.Checked, 1, 0)
        End With
    ...
    Private Sub Tool_Editar_Click(sender As Object, e As EventArgs) Handles Tool_Editar.Click
        ...
        Cambiar_Estado_Tool(ToolS_Mantenimiento)
        txt_cod.Text = dgv_lista.CurrentRow.Cells("CC_ID").Value
        txt_des.Text = dgv_lista.CurrentRow.Cells("CC_DESCRIPCION").Value
        chk_estado.Checked = IIf(dgv_lista.CurrentRow.Cells("CC_ESTADO").Value = 1, True, False)
    ...
    Private Sub Tool_Eliminar_Click(sender As Object, e As EventArgs) Handles Tool_Eliminar.Click
        ...
        If MsgBox("Seguro de Eliminar?", MsgBoxStyle.Question, "Cuidado!") = MsgBoxResult.Yes Then
            ...
            Dim catBL As New ClsOperaciones.AF_MA_CENCOS
            With catBE
                .CC_ID = dgv_lista.CurrentRow.Cells("CC_ID").Value
            End With
            catBL.delete(catBE)
            catBE = Nothing
            catBL = Nothing
